...
void update_joint_homing_params(int jno, double home_offset, double home_home, int home_sequence);

//---------------------------------------------------------------------
// CONTROL routines

// one-time initialization (return 0 if ok):
int homing_init(int id, double servo_period,
...
void homeMotFunctions(void (*pSetRotaryUnlock)(int, int), int (*pGetRotaryUnlock)(int));
