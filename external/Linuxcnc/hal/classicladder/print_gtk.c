...
void DoPrint(char DoPreview) {
    ...
    res = gtk_print_operation_run(print, DoPreview ? GTK_PRINT_OPERATION_ACTION_PREVIEW : GTK_PRINT_OPERATION_ACTION_PRINT_DIALOG, GTK_WINDOW(MainSectionWindow), NULL);
