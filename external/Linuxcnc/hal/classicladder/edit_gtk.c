...
static short int ToolBarElementsLadder[][NBR_ELE_TOOLBAR_X_MAX] = { { EDIT_POINTER, EDIT_ERASER, EDIT_SELECTION, EDIT_COPY },
...
static short int ToolBarElementsSequential[][NBR_ELE_TOOLBAR_X_MAX] = { { EDIT_POINTER, EDIT_ERASER, 0, 0 }, { ELE_SEQ_STEP, EDIT_SEQ_INIT_STEP, 0, 0 }, { ELE_SEQ_TRANSITION, EDIT_SEQ_STEP_AND_TRANS, 0, 0 }, { EDIT_SEQ_START_MANY_TRANS, EDIT_SEQ_END_MANY_TRANS, 0, 0 }, { EDIT_SEQ_START_MANY_STEPS, EDIT_SEQ_END_MANY_STEPS, 0, 0 }, { EDIT_SEQ_LINK, 0, 0, 0 }, { ELE_SEQ_COMMENT, 0, 0, 0 }, { -1, -1 } /*end*/ };
char *ToolBarToolTipsTextSequential[][NBR_ELE_TOOLBAR_X_MAX] = { { N_("Current Object\nSelector"), N_("Eraser"), NULL, NULL }, { N_("Step"), NULL, NULL, NULL }, { N_("Transition"), NULL, NULL, NULL }, { NULL, NULL, NULL, NULL }, { NULL, NULL, NULL, NULL }, { N_("Link"), NULL, NULL, NULL }, { N_("Comment"), NULL, NULL, NULL }, { NULL, NULL, NULL, NULL } };
#endif
...
void CreateOneToolbar(GtkWidget *Box, int NumTable, char *PtrOnToolTipsText[][NBR_ELE_TOOLBAR_X_MAX]) {
    ...
    do {
        ...
        if (ToolBarEle.Type != 0) {
            ...
            gtk_table_attach(GTK_TABLE(pToolbarDatas->ToolbarTable), pToolbarDatas->ToolbarBtnRadio[ScanToolBarY][ScanToolBarX], ScanToolBarX, ScanToolBarX + 1, ScanToolBarY, ScanToolBarY + 1, 0, 0, 0, 0);
...
void EditorInitGtk() {
    ...
    gtk_signal_connect(GTK_OBJECT(EditWindow), "delete_event", GTK_SIGNAL_FUNC(EditorWindowDeleteEvent), 0);
