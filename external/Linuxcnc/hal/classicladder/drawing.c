        ...
        if (*Ptr == '@') {
            ...
            if (IdentifyVarIndexedOrNot(Ptr, &TypeVar, &NumVar, &IndexTypeVar, &IndexNumVar)) {
                if (IndexTypeVar != -1 && IndexNumVar != -1) {
                    ...
                    if (ret >= sizeof(VarBuffer))
                        snprintf(VarBuffer, sizeof(VarBuffer), "<format too long>");
                } else {
...
void DrawCommonElementForToolbar(cairo_t *cr, int x, int y, int Size, int NumElement) {
    ...
    switch (NumElement) {
        case EDIT_POINTER:
            my_cairo_draw_line(cr, x + SizeDiv4, y + SizeDiv4, x + Size - SizeDiv4, y + Size - SizeDiv4); /* \ */
            my_cairo_draw_line(cr, x + SizeDiv4, y + SizeDiv4, x + SizeDiv3, y + SizeDiv2);               /* | */
            my_cairo_draw_line(cr, x + SizeDiv4, y + SizeDiv4, x + SizeDiv2, y + SizeDiv3);               /* _ */
            my_cairo_draw_line(cr, x + SizeDiv3, y + SizeDiv2, x + SizeDiv2, y + SizeDiv3);
            break;
        case EDIT_ERASER:
            my_cairo_draw_line(cr, x + SizeDiv3, y + SizeDiv4, x + Size - SizeDiv4, y + SizeDiv4);
            my_cairo_draw_line(cr, x + SizeDiv4, y + Size - SizeDiv4, x + Size - SizeDiv3, y + Size - SizeDiv4);
            my_cairo_draw_line(cr, x + SizeDiv3, y + SizeDiv4, x + SizeDiv4, y + Size - SizeDiv4);
            my_cairo_draw_line(cr, x + Size - SizeDiv4, y + SizeDiv4, x + Size - SizeDiv3, y + Size - SizeDiv4);
            my_cairo_draw_line(cr, x + SizeDiv4 + 2, y + Size - SizeDiv4 + 2, x + Size - SizeDiv3 + 2, y + Size - SizeDiv4 + 2);
            my_cairo_draw_line(cr, x + Size - SizeDiv4 + 2, y + SizeDiv4 + 2, x + Size - SizeDiv3 + 2, y + Size - SizeDiv4 + 2);
            break;
        case EDIT_SELECTION: {
...
// Cairo....
    ...
    gdk_gc_set_line_attributes(DynaGcOn, THICK_LINE_ELE_ACTIVATED, GDK_LINE_SOLID, GDK_CAP_BUTT, GDK_JOIN_MITER);
#endif
    ...
    switch (Element.Type) {
        case ELE_INPUT_NOT:
        case ELE_OUTPUT_NOT:
            my_cairo_draw_line(cr, x + WidDiv3, y + Height - HeiDiv4, x + WidDiv3 * 2, y + HeiDiv4);
    }
    /* Drawing ^ or \/  */
    switch (Element.Type) {
        case ELE_RISING_INPUT:
            my_cairo_draw_line(cr, x + WidDiv3, y + HeiDiv3 * 2, x + WidDiv4 * 2, y + HeiDiv3);
            my_cairo_draw_line(cr, x + WidDiv4 * 2, y + HeiDiv3, x + WidDiv3 * 2, y + HeiDiv3 * 2);
            break;
        case ELE_FALLING_INPUT:
            my_cairo_draw_line(cr, x + WidDiv3, y + HeiDiv3, x + WidDiv4 * 2, y + HeiDiv3 * 2);
            my_cairo_draw_line(cr, x + WidDiv4 * 2, y + HeiDiv3 * 2, x + WidDiv3 * 2, y + HeiDiv3);
            break;
    }
    ...
    switch (Element.Type) {
        ...
        case ELE_OUTPUT_CALL:
            my_cairo_draw_line(cr, x, y + HeiDiv2, x + WidDiv3, y + HeiDiv2);
            my_cairo_draw_line(cr, x + WidDiv3 * 2, y + HeiDiv2, x + Width, y + HeiDiv2);
    }
    /* Drawing || or () or --- */
    switch (Element.Type) {
        case ELE_INPUT:
        ...
        case ELE_RISING_INPUT:
        case ELE_FALLING_INPUT:
            my_cairo_draw_line(cr, x + WidDiv3, y + HeiDiv4, x + WidDiv3, y + Height - HeiDiv4);
            my_cairo_draw_line(cr, x + WidDiv3 * 2, y + HeiDiv4, x + WidDiv3 * 2, y + Height - HeiDiv4);
            break;
        case ELE_CONNECTION:
            my_cairo_draw_line(cr, x, y + HeiDiv2, x + Width, y + HeiDiv2);
            break;
        case ELE_OUTPUT:
        case ELE_OUTPUT_NOT:
        case ELE_OUTPUT_SET:
    ...
    switch (Element.Type) {
        ...
        case ELE_TIMER:
            ...
            my_cairo_draw_black_rectangle(cr, x + WidDiv3 - Width, y + HeiDiv3, Width + 1 * WidDiv3, Height + 1 * HeiDiv3);
            /* input : enable */
            my_cairo_draw_color_line(cr, Timer->InputEnable && DisplayColorState, x - Width, y + HeiDiv2, x - Width + WidDiv3, y + HeiDiv2);
            DrawPangoText(cr, x - Width + 2, y + HeiDiv2 - 1, -1, -1, "E");
            /* input : control */
            my_cairo_draw_color_line(cr, Timer->InputControl && DisplayColorState, x - Width, y + HeiDiv2 + Height, x - Width + WidDiv3, y + HeiDiv2 + Height);
            DrawPangoText(cr, x - Width + 2, y + HeiDiv2 - 1 + Height, -1, -1, "C");
            /* output : done */
            my_cairo_draw_color_line(cr, Timer->OutputDone && DisplayColorState, x + WidDiv3 * 2, y + HeiDiv2, x + Width, y + HeiDiv2);
            DrawPangoText(cr, x + Width - WidDiv4, y + HeiDiv2 - 1, -1, -1, "D");
            /* output : running */
            my_cairo_draw_color_line(cr, Timer->OutputRunning && DisplayColorState, x + WidDiv3 * 2, y + HeiDiv2 + Height, x + Width, y + HeiDiv2 + Height);
        ...
        case ELE_MONOSTABLE:
            ...
            my_cairo_draw_black_rectangle(cr, x + WidDiv3 - Width, y + HeiDiv3, Width + 1 * WidDiv3, Height + 1 * HeiDiv3);
            /* input */
            my_cairo_draw_color_line(cr, Monostable->Input && DisplayColorState, x - Width, y + HeiDiv2, x - Width + WidDiv3, y + HeiDiv2);
            DrawPangoText(cr, x - Width, y + HeiDiv2 - 1, -1, -1, "I^");
            /* output : running */
            my_cairo_draw_color_line(cr, Monostable->OutputRunning && DisplayColorState, x + WidDiv3 * 2, y + HeiDiv2, x + Width, y + HeiDiv2);
        ...
        case ELE_COUNTER:
            ...
            my_cairo_draw_black_rectangle(cr, x + WidDiv3 - Width, y + HeiDiv3, Width + 1 * WidDiv3, 3 * Height + 1 * HeiDiv3);
            /* input : reset */
            my_cairo_draw_color_line(cr, Counter->InputReset && DisplayColorState, x - Width, y + HeiDiv2, x - Width + WidDiv3, y + HeiDiv2);
            DrawPangoText(cr, x - Width + WidDiv4 / 2, y + HeiDiv2 - 1, -1, -1, "R");
            /* input : preset */
            my_cairo_draw_color_line(cr, Counter->InputPreset && DisplayColorState, x - Width, y + HeiDiv2 + Height, x - Width + WidDiv3, y + HeiDiv2 + Height);
            DrawPangoText(cr, x - Width + WidDiv4 / 2, y + HeiDiv2 - 1 + Height, -1, -1, "P");
            /* input : count up */
            my_cairo_draw_color_line(cr, Counter->InputCountUp && DisplayColorState, x - Width, y + HeiDiv2 + Height * 2, x - Width + WidDiv3, y + HeiDiv2 + Height * 2);
            DrawPangoText(cr, x - Width + WidDiv4 / 2, y + HeiDiv2 - 1 + Height * 2, -1, -1, "U");
            /* input : count down */
            my_cairo_draw_color_line(cr, Counter->InputCountDown && DisplayColorState, x - Width, y + HeiDiv2 + Height * 3, x - Width + WidDiv3, y + HeiDiv2 + Height * 3);
            DrawPangoText(cr, x - Width + WidDiv4 / 2, y + HeiDiv2 - 1 + Height * 3, -1, -1, "D");
            /* output : empty */
            my_cairo_draw_color_line(cr, Counter->OutputEmpty && DisplayColorState, x + WidDiv3 * 2, y + HeiDiv2, x + Width, y + HeiDiv2);
            DrawPangoText(cr, x + Width - WidDiv4, y + HeiDiv2 - 1, -1, -1, "E");
            /* output : done */
            my_cairo_draw_color_line(cr, Counter->OutputDone && DisplayColorState, x + WidDiv3 * 2, y + HeiDiv2 + Height, x + Width, y + HeiDiv2 + Height);
            DrawPangoText(cr, x + Width - WidDiv4, y + HeiDiv2 - 1 + Height, -1, -1, "D");
            /* output : full */
            my_cairo_draw_color_line(cr, Counter->OutputFull && DisplayColorState, x + WidDiv3 * 2, y + HeiDiv2 + Height * 2, x + Width, y + HeiDiv2 + Height * 2);
        ...
        case ELE_TIMER_IEC:
            ...
            my_cairo_draw_black_rectangle(cr, x + WidDiv3 - Width, y + HeiDiv3, Width + 1 * WidDiv3, Height + 1 * HeiDiv3);
            /* input : enable */
            my_cairo_draw_color_line(cr, TimerIEC->Input && DisplayColorState, x - Width, y + HeiDiv2, x - Width + WidDiv3, y + HeiDiv2);
            DrawPangoText(cr, x - Width + WidDiv4 / 1.5, y + HeiDiv2 - 1, -1, -1, "I");
            /* output : done */
            my_cairo_draw_color_line(cr, TimerIEC->Output && DisplayColorState, x + WidDiv3 * 2, y + HeiDiv2, x + Width, y + HeiDiv2);
        ...
        case ELE_COMPAR:
            ...
            my_cairo_draw_black_rectangle(cr, x + WidDiv3 - (Width * 2), y + HeiDiv4, Width * 2 + 1 * WidDiv3, 2 * HeiDiv4);
            /* input */
            my_cairo_draw_line(cr, x - Width * 2, y + HeiDiv2, x - Width * 2 + WidDiv3, y + HeiDiv2);
            /* output */
            my_cairo_draw_line(cr, x + WidDiv3 * 2, y + HeiDiv2, x + Width, y + HeiDiv2);
    ...
    if (Element.ConnectedWithTop) {
        if (Element.DynamicInput && DisplayColorState)
            my_cairo_draw_color_line(cr, 1, x, y + HeiDiv2 + 1, x, y - HeiDiv2);
        else
            my_cairo_draw_color_line(cr, 0, x, y + HeiDiv2 + 1, x, y - HeiDiv2);
    }
    ...
    if (DrawingOption == DRAW_FOR_TOOLBAR) {
        switch (Element.Type) {
            case EDIT_CNX_WITH_TOP:
                my_cairo_draw_color_line(cr, 0, x + WidDiv2, y + HeiDiv4, x + WidDiv2, y + Height - HeiDiv4);
                break;
            case EDIT_LONG_CONNECTION:
                my_cairo_draw_line(cr, x, y + HeiDiv2, x + Width - 1, y + HeiDiv2);
                my_cairo_draw_line(cr, x + 3 * WidDiv4 - 1, y + HeiDiv4, x + Width - 1, y + HeiDiv2);
                my_cairo_draw_line(cr, x + 3 * WidDiv4 - 1, y + 3 * HeiDiv4, x + Width - 1, y + HeiDiv2);
                my_cairo_draw_line(cr, x + 3 * WidDiv4 - 1, y + HeiDiv4, x + 3 * WidDiv4 + 3, y + HeiDiv2);
                my_cairo_draw_line(cr, x + 3 * WidDiv4 + 3, y + HeiDiv2, x + 3 * WidDiv4 - 1, y + 3 * HeiDiv4);
                break;
            ...
            case ELE_TIMER_IEC: {
                ...
                if (Element.Type == ELE_TIMER_IEC)
                    Letter = "TM";
                my_cairo_draw_black_rectangle(cr, x /*+WidDiv4*/, y + HeiDiv4, Width - 2 /**WidDiv4*/, Height - 2 * HeiDiv4);
...
void DrawRungs(cairo_t *cr) {
    ...
    for (ScanY = InfosGene->OffsetHiddenTopRungDisplayed * -1; ScanY < InfosGene->PageHeight && !TheEnd; ScanY = ScanY + (TOTAL_PX_RUNG_HEIGHT)) {
        ...
        if (ScanRung == InfosGene->CurrentRung && EditDatas.ModeEdit) {
            if ((FlagAddOrInsertRung && EditDatas.DoBeforeFinalCopy == MODE_INSERT) || (!FlagAddOrInsertRung && EditDatas.DoBeforeFinalCopy == MODE_ADD) || EditDatas.DoBeforeFinalCopy == MODE_MODIFY) {
