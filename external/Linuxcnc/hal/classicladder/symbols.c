    ...
    if (tcVarNameVar[0] == '%') {
        ...
        *pVarNameDest = '\0';
        ...
        do {
            ...
            if (strcmp(tcVarNameVar, pCurrentSymbol->VarName) == 0 || strcmp(tcVarNamePartial, pCurrentSymbol->VarName) == 0) {
                bFound = TRUE;
    ...
    *pVarNameDest = '\0';
    ...
    do {
        ...
        if (pCurrentSymbol->Symbol[0] != '\0') {
            // verify strings for complete & partial
            if (strcmp(tcMnemoSaisi, pCurrentSymbol->Symbol) == 0 || strcmp(tcPartialSymbolString, pCurrentSymbol->Symbol) == 0) {
                bFound = TRUE;
                pFoundSymbol = pCurrentSymbol;
            }
        }
