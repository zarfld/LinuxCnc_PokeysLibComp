...
static int *kvlist_lookup(struct rtapi_list_head *head, const char *name) {
    ...
    rtapi_list_for_each(ptr, head) {
        ...
        if (strncmp(name, ent->key, sizeof(ent->key)) == 0)
            return &ent->value;
    }
...
static const char *hm2_7i96_pin_names[] = {
    "TB3-01",        "TB3-02",        "TB3-03",        "TB3-04",        "TB3-05",        "TB3-06",        "TB3-07",        "TB3-08",        "TB3-09",        "TB3-10",        "TB3-11",        "TB3-13/TB3-14", "TB3-15/TB3-16", "TB3-17/TB3-18", "TB3-19/TB3-20", "TB3-21/TB3-22", "TB3-23/TB3-24",

    "TB1-02/TB1-03", "TB1-04/TB1-05", "TB1-08/TB1-09", "TB1-10/TB1-11", "TB1-14/TB1-15", "TB1-16/TB1-17", "TB1-20/TB1-21", "TB1-22-TB1-23",

    "TB2-02/TB2-03", "TB2-04/TB2-05", "TB2-07/TB2-08", "TB2-10/TB2-11", "TB2-13/TB2-14", "TB2-16/TB2-17", "TB2-18/TB2-19",

    "internal", /* SSerial TXEN */
    "internal", /* SSR AC Reference pin */

    "P1-01/DB25-01", /* P1 parallel expansion */
    "P1-02/DB25-14", "P1-03/DB25-02", "P1-04/DB25-15", "P1-05/DB25-03", "P1-06/DB25-16", "P1-07/DB25-04", "P1-08/DB25-17", "P1-09/DB25-05", "P1-11/DB25-06", "P1-13/DB25-07", "P1-15/DB25-08", "P1-17/DB25-09", "P1-19/DB25-10", "P1-21/DB25-11", "P1-23/DB25-12", "P1-25/DB25-13",
};

static const char *hm2_7i94_pin_names[] = { "P2-01/DB25-01", /* P2 parallel expansion */
                                            "P2-02/DB25-14", "P2-03/DB25-02", "P2-04/DB25-15", "P2-05/DB25-03", "P2-06/DB25-16", "P2-07/DB25-04", "P2-08/DB25-17", "P2-09/DB25-05", "P2-11/DB25-06", "P2-13/DB25-07", "P2-15/DB25-08", "P2-17/DB25-09", "P2-19/DB25-10", "P2-21/DB25-11", "P2-23/DB25-12", "P2-25/DB25-13", "J6-RX0",   "J6-TX0", "J6-TXEN0", "J7-RX1",

                                            "J7-TX1",        "J7-TXEN1",      "J8-RX2",        "J8-TX2",        "J8-TXEN2",      "J9-RX3",        "J9-TX3",        "J9-TXEN3",      "J4-RX4",        "J4-TX4",        "J4-TXEN4",      "J3-RX5",        "J3-TX5",        "J3-TXEN5",      "J2-RX6",        "J2-TX6",        "J2-TXEN6", "J1-RX7", "J1-TX7",   "J1-TXEN7", "P2-/IOENA" };

static const char *hm2_7i95_pin_names[] = {
    "TB3-02/TB3-03",                                                                                                                                                                                                             /* Step/Dir/Misc 5V out */
    "TB3-04/TB3-05",   "TB3-08/TB3-09",   "TB3-10/TB3-11",   "TB3-14/TB3-15",   "TB3-16/TB3-17",      "TB3-20/TB3-21", "TB3-22/TB3-23", "TB4-02/TB4-03", "TB4-04/TB4-05",   "TB4-08/TB4-09",   "TB4-10/TB4-11", "TB4-14/TB4-15", /* RS-422/RS-485 interface */
    "TB4-16/TB4-17",   "TB3-16/TB3-17",   "TB4-20/TB4-21",   "TB4-22/TB4-23",   "TB4-22/TB4-23",      "TB1-01/TB1-09",                                                                                                           /* Muxed encoders */
    "TB1-04/TB1-12",   "TB1-07/TB1-15",   "TB1-17/TB2-01",   "TB1-20/TB2-04",   "TB1-23/TB2-07",      "TB2-09/TB2-17", "TB2-12/TB2-20", "TB2-15/TB2-23", "Internal EncMux", "Internal InMux0",                                   /* InMux */
    "Internal InMux1", "Internal InMux2", "Internal InMux3", "Internal InMux4", "Internal InMuxData", "TB5-13/TB5-14",                                                                                                           /* SSR */
    "TB5-15/TB5-16",   "TB5-17/TB5-18",   "TB5-19/TB5-20",   "TB5-21/TB5-22",   "TB5-23/TB5-24",      "internal",
...
static const char *hm2_7i97_pin_names[] = {
    "TB3-04", /* Analog out */
    "TB3-08",          "TB3-12",          "TB3-16",          "TB3-20",
    "AN_ENA4",         "TB3-24",          "AN_ENA5",         "AN-ENA0..3",
    "TB1-01/TB1-09", /* Muxed encoders */
    "TB1-04/TB1-12",   "TB1-07/TB1-15",   "TB1-17/TB2-01",   "TB1-20/TB2-04",
    "TB1-23/TB2-07",   "TB2-09/TB2-17",

    "TB2-12/TB2-20",   "TB2-15/TB2-23",   "Internal EncMux", "TB5-13/TB5-14", /* SSR */
    "TB5-15/TB5-16",   "TB5-17/TB5-18",   "TB5-19/TB5-20",   "TB5-21/TB5-22",
    "TB5-23/TB5-24",   "Internal InMux0", /* InMux */
    "Internal InMux1", "Internal InMux2", "Internal InMux3", "Internal InMuxData",
    "TB4-15/TB4-16", /* RS-422/RS-485 interface */
    "TB4-17/TB4-18",   "TB4-17/TB4-18",

    "P1-01/DB25-01", /* P1 parallel expansion */
    "P1-02/DB25-14",   "P1-03/DB25-02",   "P1-04/DB25-15",   "P1-05/DB25-03",
    "P1-06/DB25-16",   "P1-07/DB25-04",   "P1-08/DB25-17",   "P1-09/DB25-05",
    "P1-11/DB25-06",   "P1-13/DB25-07",   "P1-15/DB25-08",   "P1-17/DB25-09",
    "P1-19/DB25-10",   "P1-21/DB25-11",   "P1-23/DB25-12",   "P1-25/DB25-13",
};

static const char *hm2_Mc04_pin_names[] = { "Relay2",
                                            "Relay3",
                                            "Relay4",
                                            "Relay5",
                                            "Relay1",
...
static bool chain_exists() {
    int result = shell(IPTABLES " -n -L " CHAIN " > /dev/null 2>&1");
...
static char *fetch_ifname(int sockfd, char *buf, size_t n) {
    ...
    for (it = ifa; it; it = it->ifa_next) {
        ...
        if (ifaddr == NULL)
            continue;
        if (ifaddr->sin_family != srcaddr.sin_family)
            continue;
        if (ifaddr->sin_addr.s_addr != srcaddr.sin_addr.s_addr)
            continue;
...
static int install_iptables_rule(const char *fmt, ...) {
    char commandbuf[1024], *ptr = commandbuf, *ebuf = commandbuf + sizeof(commandbuf);
...
static int install_iptables_board(int sockfd) {
    ...
    res = install_iptables_rule("-p udp -m udp -d %s --dport %d -s %s --sport %d -j ACCEPT", inet_ntoa_buf(dstaddr.sin_addr, dsthost, sizeof(dsthost)), ntohs(dstaddr.sin_port), inet_ntoa_buf(srcaddr.sin_addr, srchost, sizeof(srchost)), ntohs(srcaddr.sin_port));
    return res;
}
...
static int install_iptables_perinterface(const char *ifbuf) {
    ...
    // per second.
    int res = install_iptables_rule("-o %s -p icmp -j DROP", ifbuf);
    if (res < 0)
        return res;

    res = install_iptables_rule("-o %s -j REJECT --reject-with icmp-admin-prohibited", ifbuf);
    if (res < 0)
        return res;
...
static int init_board(hm2_eth_t *board, const char *board_ip) {
    ...
    if (!use_iptables()) {
        LL_PRINT("WARNING: Unable to restrict other access to the hm2-eth device.\n"
...
static int hm2_eth_read(hm2_lowlevel_io_t *this, rtapi_u32 addr, void *buffer, int size) {
    ...
    LL_PRINT_IF(debug, "read(%d) : PACKET SENT [CMD:%02X%02X | ADDR: %02X%02X | SIZE: %d]\n", board->read_cnt, read_packet.cmd_hi, read_packet.cmd_lo, read_packet.addr_lo, read_packet.addr_hi, size);
    t1 = rtapi_get_time();
    do {
        errno = 0;
...
static bool record_soft_error(hm2_eth_t *board) {
    if (!board->hal)
        return 1; // still early in hm2_eth_probe
...
static int hm2_eth_reset(hm2_lowlevel_io_t *this) {
    ...
    if (ret < 0)
        perror("eth_socket_send(bite_packet)");
    return ret < 0 ? -errno : 0;
}
...
static int hm2_eth_write(hm2_lowlevel_io_t *this, rtapi_u32 addr, const void *buffer, int size) {
    ...
    if (send < 0)
        LL_PRINT("ERROR: sending packet: %s\n", strerror(errno));
    LL_PRINT_IF(debug, "write(%d): PACKET SENT [CMD:%02X%02X | ADDR: %02X%02X | SIZE: %d]\n", board->write_cnt, packet.wr_packet.cmd_hi, packet.wr_packet.cmd_lo, packet.wr_packet.addr_lo, packet.wr_packet.addr_hi, size);
...
static int hm2_eth_items(hm2_eth_t *board) {
    ...
    if ((r = hal_param_s32_newf(HAL_RW, &board->hal->read_timeout, board->llio.comp_id, "%s.packet-read-timeout", board->llio.name)) < 0)
        return r;
    board->hal->read_timeout = 80;

    if ((r = hal_param_s32_newf(HAL_RW, &board->hal->packet_error_limit, board->llio.comp_id, "%s.packet-error-limit", board->llio.name)) < 0)
        return r;
    board->hal->packet_error_limit = 10;

    if ((r = hal_param_s32_newf(HAL_RW, &board->hal->packet_error_increment, board->llio.comp_id, "%s.packet-error-increment", board->llio.name)) < 0)
        return r;
    board->hal->packet_error_increment = 2;

    if ((r = hal_param_s32_newf(HAL_RO, &board->hal->packet_error_decrement, board->llio.comp_id, "%s.packet-error-decrement", board->llio.name)) < 0)
        return r;
    board->hal->packet_error_decrement = 1;

    if ((r = hal_pin_bit_newf(HAL_OUT, &board->hal->packet_error, board->llio.comp_id, "%s.packet-error", board->llio.name)) < 0)
        return r;
    *board->hal->packet_error = 0;

    if ((r = hal_pin_u32_newf(HAL_IO, &board->hal->packet_error_total, board->llio.comp_id, "%s.packet-error-total", board->llio.name)) < 0)
        return r;
    *board->hal->packet_error_total = 0;

    if ((r = hal_pin_s32_newf(HAL_OUT, &board->hal->packet_error_level, board->llio.comp_id, "%s.packet-error-level", board->llio.name)) < 0)
        return r;
    *board->hal->packet_error_level = 0;

    if ((r = hal_pin_bit_newf(HAL_OUT, &board->hal->packet_error_exceeded, board->llio.comp_id, "%s.packet-error-exceeded", board->llio.name)) < 0)
        return r;
    *board->hal->packet_error_exceeded = 0;
