...
static const hm2_sserial_data_t hm2_8i20_params[] = { { LBP_DATA, 0x10, LBP_UNSIGNED, LBP_OUT, 0.0, 1.0, 0, "degrees", "angle", 0 },
...
static const hm2_sserial_data_t hm2_8i20_globals[] = { { LBP_DATA, 0x10, LBP_UNSIGNED, LBP_IN, 0, 0, 2164, "none", "swrevision", 0 },        { LBP_DATA, 0x20, LBP_UNSIGNED, LBP_IN, 0, 0, 2344, "none", "unitnumber", 0 },        { LBP_DATA, 0x10, LBP_NONVOL_UNSIGNED, LBP_OUT, 0, 32.768, 2, "amps", "nvmaxcurrent", 0 }, { LBP_DATA, 0x10, LBP_NONVOL_UNSIGNED, LBP_OUT, 0, 0, 36, "volts", "nvbusundervmax", 0 }, { LBP_DATA, 0x10, LBP_NONVOL_UNSIGNED, LBP_OUT, 0, 0, 34, "volts", "nvbusundervmin", 0 },
                                                       ...
                                                       { LBP_DATA, 0x10, LBP_NONVOL_UNSIGNED, LBP_OUT, 0, 0, 14, "none", "nvkqihi", 0 },     { LBP_DATA, 0x10, LBP_NONVOL_UNSIGNED, LBP_OUT, 0, 0, 12, "none", "nvkqilo", 0 },     { LBP_DATA, 0x10, LBP_NONVOL_UNSIGNED, LBP_OUT, 0, 0, 16, "none", "nvkqil", 0 },           { LBP_DATA, 0x10, LBP_NONVOL_UNSIGNED, LBP_OUT, 0, 0, 18, "none", "nvkdp", 0 },           { LBP_DATA, 0x10, LBP_NONVOL_UNSIGNED, LBP_OUT, 0, 0, 22, "none", "nvkdihi", 0 },
                                                       { LBP_DATA, 0x10, LBP_NONVOL_UNSIGNED, LBP_OUT, 0, 0, 20, "none", "nvkdilo", 0 },     { LBP_DATA, 0x10, LBP_NONVOL_UNSIGNED, LBP_OUT, 0, 0, 24, "none", "nvkdil", 0 } };

static const hm2_sserial_data_t hm2_7i64_params[] = { { LBP_DATA, 0x18, LBP_BITS, LBP_OUT, 0, 0, 0, "none", "output", 0 }, { LBP_DATA, 0x18, LBP_BITS, LBP_IN, 0, 0, 0, "none", "input", 0 }, { LBP_DATA, 0x08, LBP_PAD, LBP_IN, 0, 0, 0, "pad", "pad", 0 }, { LBP_DATA, 0x10, LBP_UNSIGNED, LBP_IN, 0, 3.3, 0, "volts", "analog0", 0 }, { LBP_DATA, 0x10, LBP_UNSIGNED, LBP_IN, 0, 3.3, 0, "volts", "analog1", 0 } };
