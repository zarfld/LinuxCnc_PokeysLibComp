...
static spidev_port_t spi_ports[PORT_MAX] = {
    { .spix = { .width = 8, .name = "/dev/spidev0.0", .transfer = spi_transfer }, .fd = -1 }, { .spix = { .width = 8, .name = "/dev/spidev0.1", .transfer = spi_transfer }, .fd = -1 }, { .spix = { .width = 8, .name = "/dev/spidev1.0", .transfer = spi_transfer }, .fd = -1 }, { .spix = { .width = 8, .name = "/dev/spidev1.1", .transfer = spi_transfer }, .fd = -1 }, { .spix = { .width = 8, .name = "/dev/spidev1.2", .transfer = spi_transfer }, .fd = -1 },
};
