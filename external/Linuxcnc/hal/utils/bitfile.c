...
static const unsigned char header[BITFILE_HEADERLEN] = { 0x00, 0x09, 0x0f, 0xf0, 0x0f, 0xf0, 0x0f, 0xf0, 0x0f, 0xf0, 0x00, 0x00, 0x01 };
...
static int read_chunk(int fd, struct bitfile_chunk *ch) {
    ...
    if (len_len == 4) {
        ch->len = (int)(((__u32)(lenbuf[0]) << 24) | ((__u32)(lenbuf[1]) << 16) | ((__u32)(lenbuf[2]) << 8) | (__u32)(lenbuf[3]));
    } else {
