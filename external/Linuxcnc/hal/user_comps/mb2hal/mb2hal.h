...
typedef enum { linkRTU, linkTCP } link_type_t;

typedef enum { mbtxERR, mbtx_02_READ_DISCRETE_INPUTS, mbtx_03_READ_HOLDING_REGISTERS, mbtx_04_READ_INPUT_REGISTERS, mbtx_06_WRITE_SINGLE_REGISTER, mbtx_15_WRITE_MULTIPLE_COILS, mbtx_16_WRITE_MULTIPLE_REGISTERS, mbtx_01_READ_COILS, mbtx_05_WRITE_SINGLE_COIL, mbtxMAX } mb_tx_fnct; // modbus transaction code
typedef enum { debugSILENT, debugERR, debugOK, debugDEBUG, debugMAX } DEBUG_TYPE;                                                                                                                                                                                                       // message levels
typedef enum { retOK, retOKwithWarning, retERR } retCode;                                                                                                                                                                                                                               // functions return codes

#define ERR(debug, fmt, args...)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
    if (debug >= debugERR) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
        fprintf(stderr, "%s %s ERR: " fmt "\n", gbl.hal_mod_name, fnct_name, ##args);                                                                                                                                                                                                                                                                                                                                                                                                                                          \
    }
#define OK(debug, fmt, args...)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
    if (debug >= debugOK) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
        fprintf(stdout, "%s %s OK: " fmt "\n", gbl.hal_mod_name, fnct_name, ##args);                                                                                                                                                                                                                                                                                                                                                                                                                                           \
    }
#define DBG(debug, fmt, args...)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
    if (debug >= debugDEBUG) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
        fprintf(stdout, "%s %s DEBUG: " fmt "\n", gbl.hal_mod_name, fnct_name, ##args);                                                                                                                                                                                                                                                                                                                                                                                                                                        \
    }
#define DBGMAX(debug, fmt, args...)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
    if (debug >= debugMAX) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
        fprintf(stdout, "%s %s DEBUGMAX: " fmt "\n", gbl.hal_mod_name, fnct_name, ##args);                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    }
