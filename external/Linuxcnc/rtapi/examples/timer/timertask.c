...
unsigned long long int ull_mul(unsigned long long int a, unsigned long long int b) {
...
unsigned long long int ull_div(unsigned long long int a, unsigned long long int b) {
...
int rtapi_app_main(void) {
    ...
    /* the second arg is an arbitrary int that is passed to the timer task on
       the first iteration */
    timer_task = rtapi_task_new(timer_code, 0 /* arg */, timer_prio, module, TIMER_STACKSIZE, RTAPI_NO_FP);
    if (timer_task < 0) {
