...
unsigned int fwrite(const void *ptr, unsigned int size, unsigned int nobj, void *stream) {
    return nobj;
}
...
void __assert_fail(const char *s, const char *file, unsigned int line, const char *function) {
    return;
}
