...
int PKPoNet_export_pins(char *prefix, long extra_arg, int id, int njoints,
    ...
    if (poNET_data == NULL) {
        ...
        if (PoNet_data == NULL) {
            rtapi_print_msg(RTAPI_MSG_ERR,
                            "PK_PoNET: all_PoNET_data_t malloc failed\n");
            return -1;
        }
    } else {
    ...
    if (r != 0) {
        rtapi_print_msg(RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.PoNET.PoNETstatus failed\n",
                        __FILE__, __FUNCTION__, prefix);
        return r;
    }
    ...
    if (r != 0) {
        rtapi_print_msg(RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.PoNET.DevCount failed\n", __FILE__,
                        __FUNCTION__, prefix);
        return r;
    }
    ...
    if (r != 0) {
        rtapi_print_msg(RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.kbd48CNC.available failed\n",
                        __FILE__, __FUNCTION__, prefix);
        return r;
    }
    ...
    if (r != 0) {
        rtapi_print_msg(RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.kbd48CNC.PoNetID failed\n", __FILE__,
                        __FUNCTION__, prefix);
        return r;
    }
    ...
    if (r != 0) {
        rtapi_print_msg(RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.PoNET.Deb.Out failed\n", __FILE__,
                        __FUNCTION__, prefix);
        return r;
    }
    ...
    for (j = 0; j < 16; j++) // up to 16 PoNet Devices Supported
    {
        ...
        if (PK_PoNETGetModuleSettings(dev) == PK_OK) {
            rtapi_print_msg(
                RTAPI_MSG_DBG, "PoKeys: %s:%s: PoNet[%d].moduleID = %d\n",
            ...
            if (dev->PoNETmodule.moduleType != 0) {
                ...
                if (dev->PoNETmodule.moduleType == 0x10 &&
                    PoNet_data->kbd48CNC_available == 0) {
                    if ((dev->PoNETmodule.moduleOptions & (1 << 7)) != 0) {
                        // kbd48CNC is also detected
                        rtapi_print_msg(RTAPI_MSG_DBG,
                                        "PoKeys: %s:%s: kb48CNC detected\n",
                                        __FILE__, __FUNCTION__);
                        (PoNet_data->kbd48CNC_PoNetID) = j;
                        rtapi_print_msg(
                            RTAPI_MSG_DBG,
                            "PoKeys: %s:%s: PoNet[%d].kbd48CNC_PoNetID = %d\n",
                            __FILE__, __FUNCTION__, j,
                            PoNet_data->kbd48CNC_PoNetID);
                        ...
                        rtapi_print_msg(RTAPI_MSG_DBG,
                                        ...
                                        __FILE__, __FUNCTION__, j,
                                        PoNet_data->kbd48CNC_available);
                    }
                }
                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: %s.PoNET.%01d.moduleID\n",
                ...
                if (r != 0) {
                    rtapi_print_msg(
                        RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.PoNET.%01d.moduleID failed\n",
                        __FILE__, __FUNCTION__, prefix, j);
                    return r;
                }
                ...
                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: %s.PoNET.%01d.i2cAddress\n",
                                __FILE__, __FUNCTION__, prefix, j);
                ...
                if (r != 0) {
                    rtapi_print_msg(
                        RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.PoNET.%01d.i2cAddress failed\n",
                        __FILE__, __FUNCTION__, prefix, j);
                    return r;
                }
                addr->PoNET_i2cAddress = dev->PoNETmodule.i2cAddress;
                rtapi_print_msg(
                    RTAPI_MSG_DBG, "PoKeys: %s:%s:PoNet[%d].i2cAddress = %d\n",
                    __FILE__, __FUNCTION__, j, addr->PoNET_i2cAddress);

                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: %s.PoNET.%01d.moduleType\n",
                                __FILE__, __FUNCTION__, prefix, j);
                ...
                if (r != 0) {
                    rtapi_print_msg(
                        RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.PoNET.%01d.moduleType failed\n",
                        __FILE__, __FUNCTION__, prefix, j);
                    return r;
                }
                addr->PoNET_moduleType = dev->PoNETmodule.moduleType;
                rtapi_print_msg(
                    RTAPI_MSG_DBG, "PoKeys: %s:%s:PoNet[%d].moduleType = %d\n",
                    __FILE__, __FUNCTION__, j, addr->PoNET_moduleType);

                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: %s.PoNET.%01d.moduleSize\n",
                                __FILE__, __FUNCTION__, prefix, j);
                ...
                if (r != 0) {
                    rtapi_print_msg(
                        RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.PoNET.%01d.moduleSize failed\n",
                        __FILE__, __FUNCTION__, prefix, j);
                    return r;
                }
                addr->PoNET_moduleSize = dev->PoNETmodule.moduleSize;
                rtapi_print_msg(
                    RTAPI_MSG_DBG, "PoKeys: %s:%s:PoNet[%d].moduleSize = %d\n",
                    __FILE__, __FUNCTION__, j, addr->PoNET_moduleSize);

                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: %s.PoNET.%01d.moduleOptions\n",
                                __FILE__, __FUNCTION__, prefix, j);
                r = hal_param_u32_newf(HAL_RO, &(addr->PoNET_moduleOptions), id,
                                       "%s.PoNET.%01d.moduleOptions", prefix,
                                       j);
                if (r != 0) {
                    rtapi_print_msg(
                        RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.PoNET.%01d.moduleOptions failed\n",
                        __FILE__, __FUNCTION__, prefix, j);
                    return r;
                }
                addr->PoNET_moduleOptions = dev->PoNETmodule.moduleOptions;
                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s:PoNet[%d].moduleOptions = %d\n",
                                __FILE__, __FUNCTION__, j,
                                addr->PoNET_moduleOptions);
                for (int p = 0; p < 16; p++) {
                    rtapi_print_msg(RTAPI_MSG_DBG,
                                    "PoKeys: %s:%s: %s.PoNET.%01d.statusIn\n",
                                    __FILE__, __FUNCTION__, prefix, j);
                    r = hal_pin_u32_newf(HAL_OUT, &(addr->PoNET_statusIn[p]),
                                         id, "%s.PoNET.%01d.digin.%01d.in",
                                         prefix, j, p);
                    if (r != 0) {
                        rtapi_print_msg(
                            RTAPI_MSG_DBG,
                            "PoKeys: %s:%s: %s.PoNET.%01d.statusIn failed\n",
                            __FILE__, __FUNCTION__, prefix, j);
                        return r;
                    }

                    rtapi_print_msg(RTAPI_MSG_DBG,
                                    "PoKeys: %s:%s: %s.PoNET.%01d.statusOut\n",
                                    __FILE__, __FUNCTION__, prefix, j);
                    r = hal_pin_u32_newf(HAL_IN, &(addr->PoNET_statusOut[p]),
                                         id, "%s.PoNET.%01d.digout.%01d.out",
                                         prefix, j, p);
                    if (r != 0) {
                        rtapi_print_msg(
                            RTAPI_MSG_DBG,
                            "PoKeys: %s:%s: %s.PoNET.%01d.statusOut failed\n",
                            __FILE__, __FUNCTION__, prefix, j);
                        return r;
                    }
                }
    ...
    rtapi_print_msg(RTAPI_MSG_DBG,
                    "PoKeys: %s:%s: PoNet_data->kbd48CNC_available = %d\n",
                    __FILE__, __FUNCTION__, PoNet_data->kbd48CNC_available);
    if (PoNet_data->kbd48CNC_available != 0) {
        rtapi_print_msg(RTAPI_MSG_DBG,
                        "PoKeys: %s:%s: kbd48CNC_available != 0 \n", __FILE__,
                        __FUNCTION__);
        rtapi_print_msg(RTAPI_MSG_DBG,
                        "PoKeys: %s:%s: %s.kbd48CNC.lightValue\n", __FILE__,
                        __FUNCTION__, prefix);
        r = hal_pin_u32_newf(HAL_OUT, &(PoNet_data->kbd48CNC_lightValue), id,
                             "%s.kbd48CNC.lightValue", prefix, j);
        if (r != 0) {
            rtapi_print_msg(RTAPI_MSG_ERR,
                            "PoKeys: %s:%s: %s.kbd48CNC.lightValue failed\n",
                            __FILE__, __FUNCTION__);
            return r;
        }

        rtapi_print_msg(RTAPI_MSG_DBG,
                        "PoKeys: %s:%s: %s.kbd48CNC.KeyBrightness\n", __FILE__,
                        __FUNCTION__, prefix);
        r = hal_pin_u32_newf(HAL_OUT, &(PoNet_data->kbd48CNC_KeyBrightness), id,
                             "%s.kbd48CNC.KeyBrightness", prefix, j);
        if (r != 0) {
            rtapi_print_msg(RTAPI_MSG_ERR,
                            "PoKeys: %s:%s: %s.kbd48CNC.KeyBrightness failed\n",
                            __FILE__, __FUNCTION__);
            return r;
        }

        rtapi_print_msg(RTAPI_MSG_DBG,
                        "PoKeys: %s:%s: %s.kbd48CNC.prevBrightness\n", __FILE__,
                        __FUNCTION__, prefix);
        r = hal_pin_u32_newf(HAL_OUT, &(PoNet_data->kbd48CNC_prevBrightness),
                             id, "%s.kbd48CNC.prevBrightness", prefix, j);
        if (r != 0) {
            rtapi_print_msg(
                RTAPI_MSG_ERR,
                "PoKeys: %s:%s: %s.kbd48CNC.prevBrightness failed\n", __FILE__,
                __FUNCTION__);
            return r;
        }
        ...
        for (int j = 0; j < 48; j++) {
            ...
            if (PoNet_data->kbd48CNCio[j] == NULL) {
                PoNet_data->kbd48CNCio[j] =
                    hal_malloc(sizeof(one_kbd48CNCButton_data_t));
                if (PoNet_data->kbd48CNCio[j] == NULL) {
                    rtapi_print_msg(
                        RTAPI_MSG_ERR,
                        "Failed to allocate memory for kbd48CNCio[%d]\n", j);
                    return -1;
                }
            }
            ...
            if (PoNet_data->kbd48CNCio[j] != NULL) {
                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: %s.kbd48CNC.%01d.LED \n",
                                __FILE__, __FUNCTION__, prefix, j);
                r = hal_pin_bit_newf(HAL_IN, &(PoNet_data->kbd48CNCio[j]->LED),
                                     id, "%s.kbd48CNC.%01d.LED", prefix, j);
                if (r != 0) {
                    rtapi_print_msg(
                        RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.kbd48CNC.%01d.LED failed \n",
                        __FILE__, __FUNCTION__, prefix, j);
                    return r;
                }

                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: %s.kbd48CNC.%01d.Button \n",
                                __FILE__, __FUNCTION__, prefix, j);
                r = hal_pin_bit_newf(HAL_OUT,
                                     &(PoNet_data->kbd48CNCio[j]->Button), id,
                                     "%s.kbd48CNC.%01d.Button", prefix, j);
                if (r != 0) {
                    rtapi_print_msg(
                        RTAPI_MSG_ERR,
                        "PoKeys: %s:%s: %s.kbd48CNC.%01d.Button failed\n",
                        __FILE__, __FUNCTION__, prefix, j);
                    return r;
                }
            } else {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: %s.kbd48CNC.%01d failed\n",
                                __FILE__, __FUNCTION__, prefix, j);
            }
        }
...
void PKPoNet_Update(sPoKeysDevice *dev) {
    ...
    if (PoNet_data->kbd48CNC_available != 0) {
        ...
        *(PoNet_data->deb_out) = 220;
        if (PK_PoNETGetModuleSettings(dev) != PK_OK) {
            *(PoNet_data->deb_out) = 230;
            rtapi_print_msg(
                RTAPI_MSG_ERR,
                "PoKeys: %s:%s PK_PoNETGetModuleSettings(dev) failed\n",
                __FILE__, __FUNCTION__);
            if (PK_PoNETGetModuleSettings(dev) != PK_OK) {
            ...
            *(PoNet_data->deb_out) = 250;
            rtapi_print_msg(RTAPI_MSG_DBG,
                            "PoKeys: %s:%s PK_PoNETGetModuleSettings(dev) OK\n",
                            __FILE__, __FUNCTION__);
        }
#ifdef ULAPI
        usleep(sleepdur);
        ...
        *(PoNet_data->deb_out) = 270;
        rtapi_print_msg(RTAPI_MSG_DBG,
                        "PoKeys: %s:%s: PK_PoNETGetModuleLight(dev)\n",
                        __FILE__, __FUNCTION__);
        if (PK_PoNETGetModuleLight(dev) == PK_OK) {
            *(PoNet_data->deb_out) = 280;
            rtapi_print_msg(RTAPI_MSG_DBG,
                            "PoKeys: %s:%s: PK_PoNETGetModuleLight(dev) OK\n",
                            __FILE__, __FUNCTION__);
            if (PoNet_data->kbd48CNC_lightValue != NULL) {
                *(PoNet_data->deb_out) = 281;
                *(PoNet_data->kbd48CNC_lightValue) =
                    dev->PoNETmodule.lightValue;
            } else {
                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: kbd48CNC_lightValue is NULL\n",
                                __FILE__, __FUNCTION__);
            }
            *(PoNet_data->deb_out) = 290;

            *(PoNet_data->kbd48CNC_KeyBrightness) =
                255 - (int)(*(PoNet_data->kbd48CNC_lightValue));
            *(PoNet_data->deb_out) = 300;
            if (PoNet_data->kbd48CNC_prevBrightness !=
                PoNet_data->kbd48CNC_KeyBrightness) {
                *(PoNet_data->deb_out) = 310;
                dev->PoNETmodule.moduleID = PoNet_data->kbd48CNC_PoNetID;
                *(PoNet_data->deb_out) = 320;
                dev->PoNETmodule.PWMduty =
                    *(PoNet_data->kbd48CNC_KeyBrightness);
            ...
            rtapi_print_msg(
                RTAPI_MSG_ERR,
                "PoKeys: %s:%s: PK_PoNETGetModuleLight(dev) failed\n", __FILE__,
                __FUNCTION__);
        ...
        dev->PoNETmodule.moduleID = PoNet_data->kbd48CNC_PoNetID;
        rtapi_print_msg(RTAPI_MSG_DBG,
                        "PoKeys: %s:%s: PK_PoNETGetModuleStatusRequest(dev)\n",
                        __FILE__, __FUNCTION__);
        if (PK_PoNETGetModuleStatusRequest(dev) != PK_OK) {
            rtapi_print_msg(
                RTAPI_MSG_ERR,
                "PoKeys: %s:%s: PK_PoNETGetModuleStatusRequest(dev) failed\n",
                __FILE__, __FUNCTION__);
            ...
            rtapi_print_msg(
                RTAPI_MSG_DBG,
                "PoKeys: %s:%s: PK_PoNETGetModuleStatusRequest(dev) OK\n",
                __FILE__, __FUNCTION__);
        }
#ifdef ULAPI
        usleep(sleepdur);
        ...
        rtapi_print_msg(RTAPI_MSG_DBG,
                        ...
                        __FILE__, __FUNCTION__);
        while (PK_PoNETGetModuleStatus(dev) != PK_OK &&
               PoNet_data->kbd48CNC_Counter < 10) {
            rtapi_print_msg(RTAPI_MSG_ERR,
                            "PoKeys: %s:%s: PK_PoNETGetModuleStatus(dev) "
        ...
        if (PK_PoNETGetModuleStatus(dev) != PK_OK) {
            rtapi_print_msg(
                RTAPI_MSG_ERR,
                "PoKeys: %s:%s: PK_PoNETGetModuleStatus(dev) failed\n",
                __FILE__, __FUNCTION__);
            if (PK_PoNETGetModuleStatus(dev) != PK_OK) {
            }
        } else {
            rtapi_print_msg(RTAPI_MSG_DBG,
                            "PoKeys: %s:%s: PK_PoNETGetModuleStatus(dev) OK\n",
                            __FILE__, __FUNCTION__);
        }
#ifdef ULAPI
        usleep(sleepdur);
        ...
        for (int i = 0; i < 48; i++) {
            ...
            if (*(addr->LED) == true) {
                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: kbd48CNC_LED(%d) = true\n",
                                __FILE__, __FUNCTION__, i);
                state = true;
            } else {
                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: kbd48CNC_LED(%d) = false\n",
                                __FILE__, __FUNCTION__, i);
            }

            if ((dev->PoNETmodule.statusIn[ID / 8] & (1 << (ID % 8))) > 0) {
                rtapi_print_msg(RTAPI_MSG_DBG,
                                "PoKeys: %s:%s: kbd48CNC statusIn[%d] = %d\n",
                                __FILE__, __FUNCTION__, ID / 8,
                                dev->PoNETmodule.statusIn[ID / 8]);
                instate = true;
                state = true;
            } else {
                rtapi_print_msg(RTAPI_MSG_DBG,
            ...
            *(addr->Button) = instate;
            ...
            rtapi_print_msg(RTAPI_MSG_DBG,
                            "PoKeys: %s:%s: kbd48CNC state[%d] = %d  tmp=%d\n",
            ...
            rtapi_print_msg(RTAPI_MSG_DBG,
                            "PoKeys: %s:%s: kbd48CNC statusOut[%d] = %d\n",
                            __FILE__, __FUNCTION__, ID / 8,
                            dev->PoNETmodule.statusOut[ID / 8]);
        ...
        rtapi_print_msg(RTAPI_MSG_DBG,
                        "PoKeys: %s:%s: PK_PoNETSetModuleStatus(dev)\n",
                        __FILE__, __FUNCTION__);
        if (PK_PoNETSetModuleStatus(dev) != PK_OK) {
            rtapi_print_msg(
                RTAPI_MSG_ERR,
                "PoKeys: %s:%s: PK_PoNETSetModuleStatus(dev) failed\n",
                __FILE__, __FUNCTION__);
            ...
            rtapi_print_msg(RTAPI_MSG_DBG,
                            "PoKeys: %s:%s: PK_PoNETSetModuleStatus(dev) OK\n",
                            __FILE__, __FUNCTION__);
        }
#ifdef ULAPI
        usleep(sleepdur);
        ...
        if (PK_PoNETSetModuleStatus(dev) != PK_OK) {
            rtapi_print_msg(
                RTAPI_MSG_ERR,
                "PoKeys: %s:%s: kbd48CNC PK_PoNETSetModuleStatus(dev)\n",
                __FILE__, __FUNCTION__);
            dev->PoNETmodule.moduleID = PoNet_data->kbd48CNC_PoNetID;
            rtapi_print_msg(
                RTAPI_MSG_DBG,
            ...
            rtapi_print_msg(
                RTAPI_MSG_DBG,
                "PoKeys: %s:%s: kbd48CNC PK_PoNETSetModuleStatus(dev) OK\n",
                __FILE__, __FUNCTION__);
        }
#ifdef ULAPI
        usleep(sleepdur);
