...
int PKPEv2_export_pins(char *prefix, long extra_arg, int comp_id,
    ...
    if (r != 0)
        return r;
    r = hal_pin_bit_newf(HAL_IO, &(PEv2_data->PEv2_params_ApplyIniSettings),
                         comp_id, "%s.PEv2.params.ApplyIniSettings", prefix);
    if (r != 0)
        return r;

    for (j = 0; j < (8); j++) {
        r = hal_pin_s32_newf(HAL_OUT, &(PEv2_data->PEv2_deb_axxisout[j]),
                             comp_id, "%s.PEv2.%01d.deb.axxisout", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_deb_ishoming[j]),
                             comp_id, "%s.PEv2.%01d.deb.ishoming", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_deb_inposition[j]),
                             comp_id, "%s.PEv2.%01d.deb.inposition", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_deb_PosMode[j]),
                             comp_id, "%s.PEv2.%01d.deb.PosMode", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_deb_PosModeAct[j]),
                             comp_id, "%s.PEv2.%01d.deb.PosModeAct", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_s32_newf(HAL_OUT, &(PEv2_data->PEv2_deb_velmode_count[j]),
                             comp_id, "%s.PEv2.%01d.deb.velmode-count", prefix,
                             j);
        if (r != 0)
            return r;

        r = hal_pin_s32_newf(HAL_OUT, &(PEv2_data->PEv2_deb_posmode_count[j]),
                             comp_id, "%s.PEv2.%01d.deb.posmode-count", prefix,
                             j);
        if (r != 0)
            return r;
        ...
        r = hal_pin_float_newf(HAL_OUT, &(PEv2_data->PEv2_deb_RefSpeed[j]),
                               comp_id, "%s.PEv2.%01d.deb.RefSpeed", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_float_newf(HAL_OUT, &(PEv2_data->PEv2_deb_RefPos[j]),
                               comp_id, "%s.PEv2.%01d.deb.RefPos", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_float_newf(HAL_OUT, &(PEv2_data->PEv2_deb_RefPosSpeed[j]),
                               comp_id, "%s.PEv2.%01d.deb.RefPosSpeed", prefix,
                               j);
        if (r != 0)
            return r;
        ...
        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_AxesConfig[j]),
                               comp_id, "%s.PEv2.%01d.AxesConfig", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_SoftLimitMaximum[j]),
                               comp_id, "%s.PEv2.%01d.SoftLimitMaximum", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(
            HAL_RW, &(PEv2_data->PEv2_SoftLimitMinimum[j]), comp_id,
            "%s.hal_param_u32_newf.%01d.SoftLimitMinimum", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_HomingSpeed[j]),
                               comp_id, "%s.PEv2.%01d.HomingSpeed", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_HomingReturnSpeed[j]),
                               comp_id, "%s.PEv2.%01d.HomingReturnSpeed",
                               prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_HomeOffsets[j]),
                               comp_id, "%s.PEv2.%01d.HomeOffsets", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_u32_newf(HAL_IO, &(PEv2_data->PEv2_ProbePosition[j]),
                             comp_id, "%s.PEv2.%01d.ProbePosition", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_u32_newf(HAL_IO, &(PEv2_data->PEv2_ProbeMaxPosition[j]),
                             comp_id, "%s.PEv2.%01d.ProbeMaxPosition", prefix,
                             j);
        if (r != 0)
            return r;

        r = hal_pin_s32_newf(HAL_OUT, &(PEv2_data->PEv2_CurrentPosition[j]),
                             comp_id, "%s.PEv2.%01d.CurrentPosition", prefix,
                             j);
        if (r != 0)
            return r;

        r = hal_pin_s32_newf(HAL_IO, &(PEv2_data->PEv2_PositionSetup[j]),
                             comp_id, "%s.PEv2.%01d.PositionSetup", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_u32_newf(
            HAL_OUT, &(PEv2_data->PEv2_ReferencePositionSpeed[j]), comp_id,
            "%s.PEv2.%01d.ReferencePositionSpeed", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_u32_newf(HAL_OUT, &(PEv2_data->PEv2_ReferencePosition[j]),
                             comp_id, "%s.PEv2.%01d.ReferencePosition", prefix,
                             j);
        if (r != 0)
            return r;

        r = hal_pin_u32_newf(HAL_OUT, &(PEv2_data->PEv2_ReferenceSpeed[j]),
                             comp_id, "%s.PEv2.%01d.ReferenceSpeed", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(HAL_RW, &(PEv2_data->PEv2_MaxSpeed[j]),
                                 comp_id, "%s.PEv2.%01d.MaxSpeed", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(HAL_RW, &(PEv2_data->PEv2_MaxAcceleration[j]),
                                 comp_id, "%s.PEv2.%01d.MaxAcceleration",
                                 prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(HAL_RW, &(PEv2_data->PEv2_MaxDecceleration[j]),
                                 comp_id, "%s.PEv2.%01d.MaxDecceleration",
                                 prefix, j);
        if (r != 0)
            return r;

        //PEv2_HomePosition
        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_HomePosition[j]),
                               comp_id, "%s.PEv2.%01d.HomePosition", prefix, j);
        if (r != 0)
            return r;

        //PEv2_ArmPosition
        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_ArmPosition[j]),
                               comp_id, "%s.PEv2.%01d.ArmPosition", prefix, j);
        if (r != 0)
            return r;

        //PEv2_ZeroPosition
        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_ZeroPosition[j]),
                               comp_id, "%s.PEv2.%01d.ZeroPosition", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_PositionScale[j]),
                               comp_id, "%s.PEv2.%01d.PositionScale", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_PositionOffset[j]),
                               comp_id, "%s.PEv2.%01d.PositionOffset", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_pin_float_newf(HAL_IN, &(PEv2_data->PEv2_joint_vel_cmd[j]),
                               comp_id, "%s.PEv2.%01d.joint-vel-cmd", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_pin_float_newf(HAL_IN, &(PEv2_data->PEv2_joint_pos_cmd[j]),
                               comp_id, "%s.PEv2.%01d.joint-pos-cmd", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_pin_float_newf(HAL_OUT, &(PEv2_data->PEv2_joint_pos_fb[j]),
                               comp_id, "%s.PEv2.%01d.joint-pos-fb", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_IN, &(PEv2_data->PEv2_joint_out_home[j]),
                             comp_id, "%s.PEv2.%01d.joint-out-home", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_IN, &(PEv2_data->PEv2_joint_in_position[j]),
                             comp_id, "%s.PEv2.%01d.joint-in-position", prefix,
                             j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_IN, &(PEv2_data->PEv2_joint_kb_jog_active[j]),
                             comp_id, "%s.PEv2.%01d.joint-kb-jog-active",
                             prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(
            HAL_IN, &(PEv2_data->PEv2_joint_wheel_jog_active[j]), comp_id,
            "%s.PEv2.%01d.joint-wheel-jog-active", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_s32_newf(HAL_IN, &(PEv2_data->PEv2_stepgen_TYPE[j]),
                             comp_id, "%s.PEv2.%01d.stepgen.TYPE", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(HAL_RW, &(PEv2_data->PEv2_stepgen_HOME[j]),
                                 comp_id, "%s.PEv2.%01d.stepgen.HOME", prefix,
                                 j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(
            HAL_RW, &(PEv2_data->PEv2_stepgen_STEPGEN_MAXVEL[j]), comp_id,
            "%s.PEv2.%01d.stepgen.STEPGEN-MAXVEL", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(
            HAL_RW, &(PEv2_data->PEv2_stepgen_STEPGEN_MAXACCEL[j]), comp_id,
            "%s.PEv2.%01d.stepgen.STEPGEN-MAXACCEL", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_float_newf(
            HAL_IN, &(PEv2_data->PEv2_params_Feedback_Encoder_Id[j]), comp_id,
            "%s.PEv2.%01d.params.Feedback-Encoder-Id", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_float_newf(HAL_IN, &(PEv2_data->PEv2_stepgen_DEADBAND[j]),
                               comp_id, "%s.PEv2.%01d.stepgen.DEADBAND", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_pin_float_newf(HAL_IN, &(PEv2_data->PEv2_stepgen_MAX_OUTPUT[j]),
                               comp_id, "%s.PEv2.%01d.stepgen.MAX-OUTPUT",
                               prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_float_newf(
            HAL_IN, &(PEv2_data->PEv2_stepgen_ENCODER_SCALE[j]), comp_id,
            "%s.PEv2.%01d.stepgen.ENCODER-SCALE", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(
            HAL_RW, &(PEv2_data->PEv2_stepgen_STEP_SCALE[j]), comp_id,
            "%s.PEv2.%01d.stepgen.STEP-SCALE", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(
            HAL_RW, &(PEv2_data->PEv2_stepgen_MIN_LIMIT[j]), comp_id,
            "%s.PEv2.%01d.stepgen.MIN-LIMIT", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(
            HAL_RW, &(PEv2_data->PEv2_stepgen_MAX_LIMIT[j]), comp_id,
            "%s.PEv2.%01d.stepgen.MAX-LIMIT", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(
            HAL_RW, &(PEv2_data->PEv2_stepgen_HOME_OFFSET[j]), comp_id,
            "%s.PEv2.%01d.stepgen.HOME-OFFSET", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(
            HAL_RW, &(PEv2_data->PEv2_stepgen_HOME_SEARCH_VEL[j]), comp_id,
            "%s.PEv2.%01d.stepgen.HOME-SEARCH-VEL", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_float_newf(
            HAL_RW, &(PEv2_data->PEv2_stepgen_HOME_LATCH_VEL[j]), comp_id,
            "%s.PEv2.%01d.stepgen.HOME-LATCH-VEL", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_float_newf(
            HAL_IN, &(PEv2_data->PEv2_stepgen_HOME_FINAL_VEL[j]), comp_id,
            "%s.PEv2.%01d.stepgen.HOME-FINAL-VEL", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_s32_newf(
            HAL_IN, &(PEv2_data->PEv2_stepgen_HOME_IGNORE_LIMITS[j]), comp_id,
            "%s.PEv2.%01d.stepgen.HOME-IGNORE-LIMITS", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_MPGjogMultiplier[j]),
                               comp_id, "%s.PEv2.%01d.MPGjogMultiplier", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_MPGjogEncoder[j]),
                               comp_id, "%s.PEv2.%01d.MPGjogEncoder", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_MPGjogDivider[j]),
                               comp_id, "%s.PEv2.%01d.MPGjogDivider", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_LimitN_in[j]),
                             comp_id, "%s.PEv2.%01d.digin.LimitN.in", prefix,
                             j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_LimitN_in_not[j]),
                             comp_id, "%s.PEv2.%01d.digin.LimitN.in-not",
                             prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(
            HAL_OUT, &(PEv2_data->PEv2_digin_LimitN_DedicatedInput[j]), comp_id,
            "%s.PEv2.%01d.digin.LimitN.DedicatedInput", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_LimitP_in[j]),
                             comp_id, "%s.PEv2.%01d.digin.LimitP.in", prefix,
                             j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_LimitP_in_not[j]),
                             comp_id, "%s.PEv2.%01d.digin.LimitP.in-not",
                             prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(
            HAL_OUT, &(PEv2_data->PEv2_digin_LimitP_DedicatedInput[j]), comp_id,
            "%s.PEv2.%01d.digin.LimitP.DedicatedInput", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_Home_in[j]),
                             comp_id, "%s.PEv2.%01d.digin.Home.in", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_Home_in_not[j]),
                             comp_id, "%s.PEv2.%01d.digin.Home.in-not", prefix,
                             j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(
            HAL_OUT, &(PEv2_data->PEv2_digin_Home_DedicatedInput[j]), comp_id,
            "%s.PEv2.%01d.digin.Home.DedicatedInput", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(
            HAL_IN, &(PEv2_data->PEv2_digout_AxisEnable_out[j]), comp_id,
            "%s.PEv2.%01d.digout.AxisEnable.out", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(
            HAL_RW, &(PEv2_data->PEv2_HomeBackOffDistance[j]), comp_id,
    ...
    r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_PulseEngineEnabled),
                           comp_id, "%s.PEv2.PulseEngineEnabled", prefix);
    if (r != 0)
        return r;

    r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_PulseGeneratorType),
                           comp_id, "%s.PEv2.PulseGeneratorType", prefix);
    if (r != 0)
        return r;
    ...
    if (r != 0)
        return r;
    r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_ChargePumpEnabled),
                           comp_id, "%s.PEv2.ChargePumpEnabled", prefix);
    if (r != 0)
        return r;
    r = hal_pin_u32_newf(HAL_OUT, &(PEv2_data->PEv2_PulseEngineActivated),
                         comp_id, "%s.PEv2.PulseEngineActivated", prefix);
    if (r != 0)
        return r;
    ...
    for (j = 0; j < (8); j++) {
        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_Error_in[j]),
                             comp_id, "%s.PEv2.%01d.digin.Error.in", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_Error_in_not[j]),
                             comp_id, "%s.PEv2.%01d.digin.Error.in-not", prefix,
                             j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_Misc_in[j]),
                             comp_id, "%s.PEv2.digin.Misc-%01d.in", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_Misc_in_not[j]),
                             comp_id, "%s.PEv2.digin.Misc-%01d.in-not", prefix,
                             j);
        if (r != 0)
            return r;
    }
    ...
    if (r != 0)
        return r;
    for (j = 0; j < (8); j++) {
        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_Probe_in[j]),
                             comp_id, "%s.PEv2.%01d.digin.Probe.in", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_Probe_in_not[j]),
                             comp_id, "%s.PEv2.%01d.digin.Probe.in-not", prefix,
                             j);
        if (r != 0)
            return r;
    }
    r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_Emergency_in),
                         comp_id, "%s.PEv2.digin.Emergency.in", prefix);
    if (r != 0)
        return r;
    r = hal_pin_bit_newf(HAL_OUT, &(PEv2_data->PEv2_digin_Emergency_in_not),
                         comp_id, "%s.PEv2.digin.Emergency.in-not", prefix);
    if (r != 0)
        return r;
    r = hal_pin_bit_newf(HAL_IN, &(PEv2_data->PEv2_digout_Emergency_out),
                         comp_id, "%s.PEv2.digout.Emergency.out", prefix);
    if (r != 0)
        return r;
    for (j = 0; j < (8); j++) {
        r = hal_pin_u32_newf(HAL_OUT, &(PEv2_data->PEv2_digin_SoftLimit_in[j]),
                             comp_id, "%s.PEv2.%01d.digin.SoftLimit.in", prefix,
                             j);
        if (r != 0)
            return r;
    }
    ...
    if (r != 0)
        return r;
    r = hal_pin_u32_newf(HAL_IO, &(PEv2_data->PEv2_AxisEnabledStatesMask),
                         comp_id, "%s.PEv2.AxisEnabledStatesMask", prefix);
    if (r != 0)
        return r;
    for (j = 0; j < (8); j++) {
        r = hal_pin_bit_newf(
            HAL_IN, &(PEv2_data->PEv2_digout_AxisEnabled_out[j]), comp_id,
            "%s.PEv2.%01d.digout.AxisEnabled.out", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(
            HAL_OUT, &(PEv2_data->PEv2_digin_AxisEnabled_in[j]), comp_id,
            "%s.PEv2.%01d.digin.AxisEnabled.in", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(
            HAL_OUT, &(PEv2_data->PEv2_digout_LimitOverride_out[j]), comp_id,
            "%s.PEv2.%01d.digout.LimitOverride.out", prefix, j);
        if (r != 0)
            return r;
    }
    r = hal_pin_u32_newf(HAL_OUT, &(PEv2_data->PEv2_ExternalRelayOutputs),
                         comp_id, "%s.PEv2.ExternalRelayOutputs", prefix);
    if (r != 0)
        return r;
    ...
    for (j = 0; j < (4); j++) {
        r = hal_pin_bit_newf(
            HAL_IN, &(PEv2_data->PEv2_digout_ExternalRelay_out[j]), comp_id,
            "%s.PEv2.digout.ExternalRelay-%01d.out", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_bit_newf(
            HAL_IN, &(PEv2_data->PEv2_digout_ExternalOC_out[j]), comp_id,
            "%s.PEv2.digout.ExternalOC-%01d.out", prefix, j);
        if (r != 0)
            return r;
    }

    r = hal_pin_u32_newf(HAL_IO, &(PEv2_data->PEv2_HomingStartMaskSetup),
                         comp_id, "%s.PEv2.HomingStartMaskSetup", prefix);
    if (r != 0)
        return r;
    r = hal_pin_u32_newf(HAL_IO, &(PEv2_data->PEv2_ProbeStartMaskSetup),
                         comp_id, "%s.PEv2.ProbeStartMaskSetup", prefix);
    if (r != 0)
        return r;
    ...
    if (r != 0)
        return r;
    for (j = 0; j < (8); j++) {
        r = hal_pin_u32_newf(HAL_IO, &(PEv2_data->PEv2_BacklashWidth[j]),
                             comp_id, "%s.PEv2.%01d.BacklashWidth", prefix, j);
        if (r != 0)
            return r;

        r = hal_pin_u32_newf(HAL_IO, &(PEv2_data->PEv2_BacklashRegister[j]),
                             comp_id, "%s.PEv2.%01d.BacklashRegister", prefix,
                             j);
        if (r != 0)
            return r;

        r = hal_pin_u32_newf(HAL_IO, &(PEv2_data->PEv2_BacklashAcceleration[j]),
                             comp_id, "%s.PEv2.%01d.BacklashAcceleration",
                             prefix, j);
        if (r != 0)
            return r;
    }
    r = hal_pin_u32_newf(HAL_IO, &(PEv2_data->PEv2_BacklashCompensationEnabled),
                         comp_id, "%s.PEv2.BacklashCompensationEnabled",
                         prefix);
    if (r != 0)
        return r;

    for (j = 0; j < (8); j++) {
        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_home_sequence[j]),
                               comp_id, "%s.PEv2.%01d.home-sequence", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_AxisEnabled[j]),
                               comp_id, "%s.PEv2.%01d.AxisEnabled", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_AxisInverted[j]),
                               comp_id, "%s.PEv2.%01d.AxisInverted", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_s32_newf(
            HAL_RW, &(PEv2_data->PEv2_AxisInternalPlanner[j]), comp_id,
            "%s.PEv2.%01d.AxisInternalPlanner", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_AxisPositionMode[j]),
                               comp_id, "%s.PEv2.%01d.AxisPositionMode", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_AxisInvertedHome[j]),
                               comp_id, "%s.PEv2.%01d.AxisInvertedHome", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_param_s32_newf(
            HAL_RW, &(PEv2_data->PEv2_AxisSoftLimitEnabled[j]), comp_id,
            "%s.PEv2.%01d.AxisSoftLimitEnabled", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_s32_newf(HAL_RW, &(PEv2_data->PEv2_AxisEnabledMasked[j]),
                               comp_id, "%s.PEv2.%01d.AxisEnabledMasked",
                               prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(
            HAL_RW, &(PEv2_data->PEv2_digin_SoftLimit_PosMin[j]), comp_id,
            "%s.PEv2.%01d.digin.SoftLimit.PosMin", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(
            HAL_RW, &(PEv2_data->PEv2_digin_SoftLimit_PosMax[j]), comp_id,
            "%s.PEv2.%01d.digin.SoftLimit.PosMax", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_HomingAlgorithm[j]),
                               comp_id, "%s.PEv2.%01d.HomingAlgorithm", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_HomeAlg_OnHome_Stop[j]), comp_id,
            "%s.PEv2.%01d.HomeAlg.OnHome.Stop", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_HomeAlg_OnHome_ArmEncoder[j]), comp_id,
            "%s.PEv2.%01d.HomeAlg.OnHome.ArmEncoder", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_HomeAlg_OnHome_RevDirection[j]), comp_id,
            "%s.PEv2.%01d.HomeAlg.OnHome.RevDirection", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_HomeAlg_OnHome_ReducedSpeed[j]), comp_id,
            "%s.PEv2.%01d.HomeAlg.OnHome.ReducedSpeed", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_HomeAlg_OutHome_Stop[j]), comp_id,
            "%s.PEv2.%01d.HomeAlg.OutHome.Stop", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_HomeAlg_OutHome_ArmEncoder[j]), comp_id,
            "%s.PEv2.%01d.HomeAlg.OutHome.ArmEncoder", prefix, j);
        if (r != 0)
            return r;
        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_HomeAlg_OutHome_RevDirection[j]), comp_id,
            "%s.PEv2.%01d.HomeAlg.OutHome.RevDirection", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_HomeAlg_OutHome_ReducedSpeed[j]), comp_id,
            "%s.PEv2.%01d.HomeAlg.OutHome.ReducedSpeed", prefix, j);
        if (r != 0)
            return r;
        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_digin_Home_Offset[j]),
                               comp_id, "%s.PEv2.%01d.digin.Home.Offset",
                               prefix, j);
        if (r != 0)
            return r;
        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_AxesSwitchConfig[j]),
                               comp_id, "%s.PEv2.%01d.AxesSwitchConfig", prefix,
                               j);
        if (r != 0)
            return r;
        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_digin_LimitN_Enabled[j]), comp_id,
            "%s.PEv2.%01d.digin.LimitN.Enabled", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_digin_LimitP_Enabled[j]), comp_id,
            "%s.PEv2.%01d.digin.LimitP.Enabled", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(HAL_RW, &(PEv2_data->PEv2_digin_Home_Enabled[j]),
                               comp_id, "%s.PEv2.%01d.digin.Home.Enabled",
                               prefix, j);
        if (r != 0)
            return r;
        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_digin_Home_OnLimitN[j]), comp_id,
            "%s.PEv2.%01d.digin.Home.OnLimitN", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_digin_Home_OnLimitP[j]), comp_id,
            "%s.PEv2.%01d.digin.Home.OnLimitP", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_digin_LimitN_invert[j]), comp_id,
            "%s.PEv2.%01d.digin.LimitN.invert", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_digin_LimitP_invert[j]), comp_id,
            "%s.PEv2.%01d.digin.LimitP.invert", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(HAL_RW, &(PEv2_data->PEv2_digin_Home_invert[j]),
                               comp_id, "%s.PEv2.%01d.digin.Home.invert",
                               prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_digin_LimitN_Pin[j]),
                               comp_id, "%s.PEv2.%01d.digin.LimitN.Pin", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(
            HAL_RW, &(PEv2_data->PEv2_digin_LimitN_Filter[j]), comp_id,
            "%s.PEv2.%01d.digin.LimitN.Filter", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_digin_LimitP_Pin[j]),
                               comp_id, "%s.PEv2.%01d.digin.LimitP.Pin", prefix,
                               j);
        if (r != 0)
            return r;

        //PEv2_digin_Probe_Filter
        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_digin_Probe_Filter[j]),
                               comp_id, "%s.PEv2.%01d.digin.Probe.Filter",
                               prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(
            HAL_RW, &(PEv2_data->PEv2_digin_LimitP_Filter[j]), comp_id,
            "%s.PEv2.%01d.digin.LimitP.Filter", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_digin_Home_Pin[j]),
                               comp_id, "%s.PEv2.%01d.digin.Home.Pin", prefix,
                               j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_digin_Home_Filter[j]),
                               comp_id, "%s.PEv2.%01d.digin.Home.Filter",
                               prefix, j);
        if (r != 0)
            return r;

        r = hal_param_u32_newf(
            HAL_RW, &(PEv2_data->PEv2_digout_AxisEnable_Pin[j]), comp_id,
            "%s.PEv2.%01d.digout.AxisEnable.Pin", prefix, j);
        if (r != 0)
            return r;

        r = hal_param_bit_newf(
            HAL_RW, &(PEv2_data->PEv2_digout_AxisEnable_invert[j]), comp_id,
            "%s.PEv2.%01d.digout.AxisEnable.invert", prefix, j);
        if (r != 0)
            return r;
    }
    r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_digin_Emergency_Pin),
                           comp_id, "%s.PEv2.digin.Emergency.Pin", prefix);
    if (r != 0)
        return r;
    r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_digin_Emergency_invert),
                           comp_id, "%s.PEv2.digin.Emergency.invert", prefix);
    if (r != 0)
        return r;
    r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_digout_Emergency_Pin),
                           comp_id, "%s.PEv2.digout.Emergency.Pin", prefix);
    if (r != 0)
        return r;
    ...
    if (r != 0)
        return r;
    r = hal_param_u32_newf(HAL_RW, &(PEv2_data->PEv2_digin_Probe_invert),
                           comp_id, "%s.PEv2.digin.Probe.invert", prefix);
    if (r != 0)
        return r;
}
...
int32_t PEv2_Status2Get(sPoKeysDevice *dev) {
    ...
    if (ret == PK_OK) {
        rtapi_print_msg(RTAPI_MSG_DBG,
                        "PoKeys: %s:%s: PK_PEv2_Status2Get(dev) = PK_OK\n",
                        __FILE__, __FUNCTION__);
        ...
        for (int i = 0; i < PEv2_nrOfAxes; i++) {
            ...
            if (PEv2_data->PEv2_digin_Home_Pin[i] > 0) {
                PEv2_digin_Home_DedicatedInput(i) =
                ...
                if (PEv2_data->PEv2_digin_Home_invert[i] != 0) {
                    PEv2_digin_Home_in(i) =
                        !Get_BitOfByte(bm_DedicatedHomeInputs, i);
                    PEv2_digin_Home_in_not(i) =
                        Get_BitOfByte(bm_DedicatedHomeInputs, i);
                } else {
                    PEv2_digin_Home_in(i) =
                        Get_BitOfByte(bm_DedicatedHomeInputs, i);
...
int32_t PEv2_ExternalOutputsSet(sPoKeysDevice *dev) {
    ...
    if (PEv2_data->PEv2_PG_extended_io != 0) {
        ...
        if (ret == PK_OK) {
            ...
            rtapi_print_msg(
                RTAPI_MSG_INFO,
                "PoKeys: %s:%s: PK_PEv2_ExternalOutputsGet==PK_OK\n", __FILE__,
                __FUNCTION__);
        } else {
            rtapi_print_msg(
                RTAPI_MSG_ERR,
...
int32_t PEv2_PulseEngineSetup(sPoKeysDevice *dev) {
    ...
    switch (dev->DeviceData.DeviceTypeID) {
        case PK_DeviceID_PoKeys57CNC:
            rtapi_print_msg(RTAPI_MSG_DBG,
                            "PoKeys: %s:%s: DeviceID_PoKeys57CNC\n", __FILE__,
                            __FUNCTION__);
        ...
        case PK_DeviceID_PoKeys57CNCdb25:
            rtapi_print_msg(RTAPI_MSG_DBG,
                            "PoKeys: %s:%s: DeviceID_PoKeys57CNCdb25\n",
                            __FILE__, __FUNCTION__);
    ...
    if (PEv2_data->PEv2_PG_swap_stepdir != false) {
        PEv2_data->PEv2_PulseGeneratorType =
            Set_BitOfByte(PEv2_data->PEv2_PulseGeneratorType, 6,
    ...
    if (PEv2_data->PEv2_PG_extended_io != 0) {
        PEv2_data->PEv2_PulseGeneratorType = Set_BitOfByte(
            PEv2_data->PEv2_PulseGeneratorType, 7, true); // extended io
    } else {
        PEv2_data->PEv2_PulseGeneratorType = Set_BitOfByte(
            PEv2_data->PEv2_PulseGeneratorType, 7, false); // no extended io
    }
    ...
    if (dev->PEv2.EmergencySwitchPolarity !=
        PEv2_data->PEv2_digin_Emergency_invert) {
        dev->PEv2.EmergencySwitchPolarity =
            PEv2_data->PEv2_digin_Emergency_invert;
        doSetup = true;
    ...
    if (dev->PEv2.AxisEnabledStatesMask !=
        *PEv2_data->PEv2_AxisEnabledStatesMask) {
        dev->PEv2.AxisEnabledStatesMask =
            *PEv2_data->PEv2_AxisEnabledStatesMask;
        doSetup = true;
    ...
    if (doSetup == true) {
        if (PK_PEv2_PulseEngineSetup(dev) != PK_OK) {
            rtapi_print_msg(
                RTAPI_MSG_ERR,
                "PoKeys: %s:%s: PK_PEv2_PulseEngineSetup() != PK_OK\n",
                __FILE__, __FUNCTION__);
#ifdef ULAPI
            usleep(sleepdur);
#endif
            ...
            if (PK_SaveConfiguration(dev) == PK_OK) {
                rtapi_print_msg(
                    RTAPI_MSG_DBG,
                    "PoKeys: %s:%s: PK_SaveConfiguration() == PK_OK\n",
                    __FILE__, __FUNCTION__);
#ifdef ULAPI
                usleep(sleepdur);
#endif
...
int32_t PEv2_AdditionalParametersGet(sPoKeysDevice *dev) {
    ...
    if (PK_PEv2_AdditionalParametersGet(dev) == PK_OK) {
        rtapi_print_msg(
            ...
            __FILE__, __FUNCTION__);
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_digin_Emergency_Pin == 0) {
            PEv2_data->PEv2_digin_Emergency_Pin =
                dev->PEv2.EmergencyInputPin - 9;
        }
    } else {
...
int32_t PEv2_AdditionalParametersSet(sPoKeysDevice *dev) {
    ...
    if (ret == PK_OK) {
        rtapi_print_msg(
            RTAPI_MSG_DBG,
            "PoKeys: %s:%s: PK_PEv2_AdditionalParametersSet() == PK_OK\n",
            __FILE__, __FUNCTION__);

        // seems to apply here also defines the extenal input (values 1-8) or PoKeys pin (0-based Pin ID + 9)
        if (ApplyIniSettings == true && PEv2_data->PEv2_digin_Emergency_Pin !=
                                            dev->PEv2.EmergencyInputPin + 9) {
            dev->PEv2.EmergencyInputPin =
                PEv2_data->PEv2_digin_Emergency_Pin +
                9; //(0:dedicated, 1-8:external inputs, 9+ Pin ID-9)
            doSetup = true;

            if (PEv2_data->PEv2_digin_Emergency_Pin !=
                0) { // check if pin is parametrized in HAL
                rtapi_print_msg(
                    RTAPI_MSG_DBG,
                    "PoKeys: %s:%s: IO_data->Pin[%d].PinFunction = %d\n",
                    __FILE__, __FUNCTION__,
                    PEv2_data->PEv2_digin_Emergency_Pin - 1,
                    IO_data->Pin[PEv2_data->PEv2_digin_Emergency_Pin - 1]
                        .PinFunction);
                if (IO_data->Pin[PEv2_data->PEv2_digin_Emergency_Pin - 1]
                        .PinFunction == 0) {
                    IO_data->Pin[PEv2_data->PEv2_digin_Emergency_Pin - 1]
                        .PinFunction = PK_PinCap_digitalInput;
                } else if (IO_data->Pin[PEv2_data->PEv2_digin_Emergency_Pin - 1]
                               .PinFunction != PK_PinCap_digitalInput) {
                    rtapi_print_msg(RTAPI_MSG_ERR,
...
int32_t PEv2_AxisConfigurationGet(sPoKeysDevice *dev, int AxisId) {
    ...
    if (ret == PK_OK) {
        rtapi_print_msg(
            RTAPI_MSG_DBG,
            "PoKeys: %s:%s: PK_PEv2_AxisConfigurationGet(%d) == PK_OK\n",
        ...
        if (ApplyIniSettings == false) {
            ...
            PEv2_data->PEv2_AxisEnabled[AxisId] =
                (int)((axisConfig & PK_AC_ENABLED) != 0);
            PEv2_data->PEv2_AxisInverted[AxisId] =
                (int)((axisConfig & PK_AC_INVERTED) != 0);
            PEv2_data->PEv2_AxisInternalPlanner[AxisId] =
                (int)((axisConfig & PK_AC_INTERNAL_PLANNER) != 0);
            PEv2_data->PEv2_AxisPositionMode[AxisId] =
                (int)((axisConfig & PK_AC_POSITION_MODE) != 0);
            PEv2_data->PEv2_AxisInvertedHome[AxisId] =
                (int)((axisConfig & PK_AC_INVERTED_HOME) != 0);
            PEv2_data->PEv2_AxisSoftLimitEnabled[AxisId] =
                (int)((axisConfig & PK_AC_SOFT_LIMIT_ENABLED) != 0);
            PEv2_data->PEv2_AxisEnabledMasked[AxisId] =
                (int)((axisConfig & PK_AC_ENABLED_MASKED) != 0);
			...
			*/
            ...
            PEv2_data->PEv2_AxesSwitchConfig[AxisId] =
                dev->PEv2.AxesSwitchConfig[AxisId];

            uint8_t axisSwitchConfig = dev->PEv2.AxesSwitchConfig[AxisId];
            PEv2_data->PEv2_digin_LimitN_Enabled[AxisId] =
                (int)((axisSwitchConfig & PK_ASO_SWITCH_LIMIT_N) != 0);
            PEv2_data->PEv2_digin_LimitP_Enabled[AxisId] =
                (int)((axisSwitchConfig & PK_ASO_SWITCH_LIMIT_P) != 0);
            PEv2_data->PEv2_digin_Home_Enabled[AxisId] =
                (int)((axisSwitchConfig & PK_ASO_SWITCH_HOME) != 0);
            PEv2_data->PEv2_digin_Home_OnLimitN[AxisId] =
                (int)((axisSwitchConfig & PK_ASO_SWITCH_COMBINED_LN_H) != 0);
            PEv2_data->PEv2_digin_Home_OnLimitP[AxisId] =
                (int)((axisSwitchConfig & PK_ASO_SWITCH_COMBINED_LP_H) != 0);
            PEv2_data->PEv2_digin_LimitN_invert[AxisId] =
                (int)((axisSwitchConfig & PK_ASO_SWITCH_INVERT_LIMIT_N) != 0);
            PEv2_data->PEv2_digin_LimitP_invert[AxisId] =
                (int)((axisSwitchConfig & PK_ASO_SWITCH_INVERT_LIMIT_P) != 0);
            PEv2_data->PEv2_digin_Home_invert[AxisId] =
                (int)((axisSwitchConfig & PK_ASO_SWITCH_INVERT_HOME) != 0);
        }
        if (ApplyIniSettings == false) {
            PEv2_data->PEv2_digin_Home_Pin[AxisId] =
                dev->PEv2.PinHomeSwitch[AxisId];
        }
        if (ApplyIniSettings == false) {
            PEv2_data->PEv2_digin_LimitN_Pin[AxisId] =
                dev->PEv2.PinLimitMSwitch[AxisId];
        }
        if (ApplyIniSettings == false) {
            PEv2_data->PEv2_digin_LimitP_Pin[AxisId] =
                dev->PEv2.PinLimitPSwitch[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_HomingSpeed[AxisId] == 0) {
            PEv2_data->PEv2_HomingSpeed[AxisId] = dev->PEv2.HomingSpeed[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_HomingReturnSpeed[AxisId] == 0) {
            PEv2_data->PEv2_HomingReturnSpeed[AxisId] =
                dev->PEv2.HomingReturnSpeed[AxisId];
        }

        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_MPGjogEncoder[AxisId] == 0) {
            PEv2_data->PEv2_MPGjogEncoder[AxisId] =
                dev->PEv2.MPGjogEncoder[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_MaxSpeed[AxisId] == 0) {
            PEv2_data->PEv2_MaxSpeed[AxisId] =
                dev->PEv2.MaxSpeed[AxisId] * 1000;
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_MaxAcceleration[AxisId] == 0) {
            PEv2_data->PEv2_MaxAcceleration[AxisId] =
                dev->PEv2.MaxAcceleration[AxisId] * 1000000;
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_MaxDecceleration[AxisId] == 0) {
            PEv2_data->PEv2_MaxDecceleration[AxisId] =
                dev->PEv2.MaxDecceleration[AxisId] * 1000000;
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_SoftLimitMinimum[AxisId] == 0) {
            PEv2_data->PEv2_SoftLimitMinimum[AxisId] =
                dev->PEv2.SoftLimitMinimum[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_SoftLimitMaximum[AxisId] == 0) {
            PEv2_data->PEv2_SoftLimitMaximum[AxisId] =
                dev->PEv2.SoftLimitMaximum[AxisId];
        }
        ...
        if (PEv2_data->PEv2_stepgen_STEP_SCALE[AxisId] != 0) {
            ...
            if (ApplyIniSettings == false ||
                PEv2_data->PEv2_stepgen_STEPGEN_MAXVEL[AxisId] == 0) {
                PEv2_data->PEv2_stepgen_STEPGEN_MAXVEL[AxisId] =
                    PEv2_data->PEv2_MaxSpeed[AxisId] /
                    PEv2_data->PEv2_stepgen_STEP_SCALE[AxisId];
            }

            if (ApplyIniSettings == false ||
                PEv2_data->PEv2_stepgen_STEPGEN_MAXACCEL[AxisId] == 0) {
                PEv2_data->PEv2_stepgen_STEPGEN_MAXACCEL[AxisId] =
                    PEv2_data->PEv2_MaxAcceleration[AxisId] /
                    PEv2_data->PEv2_stepgen_STEP_SCALE[AxisId];
            }

            if (ApplyIniSettings == false ||
                PEv2_data->PEv2_stepgen_HOME_OFFSET[AxisId] == 0) {
                PEv2_data->PEv2_stepgen_HOME_OFFSET[AxisId] =
                    PEv2_data->PEv2_digin_Home_Offset[AxisId] /
                    PEv2_data->PEv2_stepgen_STEP_SCALE[AxisId];
            }

            if (ApplyIniSettings == false) {
                PEv2_data->PEv2_stepgen_HOME_SEARCH_VEL[AxisId] =
                    PEv2_data->PEv2_HomingSpeed[AxisId] *
                    PEv2_data->PEv2_stepgen_STEPGEN_MAXVEL[AxisId] / 100;
            }

            if (ApplyIniSettings == false) {
                PEv2_data->PEv2_stepgen_HOME_LATCH_VEL[AxisId] =
                    PEv2_data->PEv2_HomingReturnSpeed[AxisId] *
                    PEv2_data->PEv2_stepgen_HOME_SEARCH_VEL[AxisId] / 100;
            }
        }

        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_MPGjogMultiplier[AxisId] == 0) {
            PEv2_data->PEv2_MPGjogMultiplier[AxisId] =
                dev->PEv2.MPGjogMultiplier[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_digout_AxisEnable_Pin[AxisId] == 0) {
            PEv2_data->PEv2_digout_AxisEnable_Pin[AxisId] =
                dev->PEv2.AxisEnableOutputPins[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_digout_AxisEnable_invert[AxisId] == 0) {
            PEv2_data->PEv2_digout_AxisEnable_invert[AxisId] =
                dev->PEv2.InvertAxisEnable[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_digin_LimitN_Filter[AxisId] == 0) {
            PEv2_data->PEv2_digin_LimitN_Filter[AxisId] =
                dev->PEv2.FilterLimitMSwitch[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_digin_LimitP_Filter[AxisId] == 0) {
            PEv2_data->PEv2_digin_LimitP_Filter[AxisId] =
                dev->PEv2.FilterLimitPSwitch[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_digin_Home_Filter[AxisId] == 0) {
            PEv2_data->PEv2_digin_Home_Filter[AxisId] =
                dev->PEv2.FilterHomeSwitch[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_HomingAlgorithm[AxisId] == 0) {
            PEv2_data->PEv2_HomingAlgorithm[AxisId] =
                dev->PEv2.HomingAlgorithm[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_HomeBackOffDistance[AxisId] == 0) {
            PEv2_data->PEv2_HomeBackOffDistance[AxisId] =
                dev->PEv2.HomeBackOffDistance[AxisId];
        }
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_MPGjogDivider[AxisId] == 0) {
            PEv2_data->PEv2_MPGjogDivider[AxisId] =
                dev->PEv2.MPGjogDivider[AxisId];
        }
        ...
        if (ApplyIniSettings == false ||
            PEv2_data->PEv2_digin_Probe_Filter[AxisId] == 0) {
            PEv2_data->PEv2_digin_Probe_Filter[AxisId] =
                dev->PEv2.FilterProbeInput;
        }
...
int32_t PEv2_AxisConfigurationSet(sPoKeysDevice *dev, int AxisId) {
    ...
    if (ret == PK_OK) {
        rtapi_print_msg(
            RTAPI_MSG_DBG,
            "PoKeys: %s:%s: PEv2_AxisConfigurationSet(%d) == PK_OK\n", __FILE__,
            __FUNCTION__, AxisId);
        ...
        if (ApplyIniSettings == true) {
			...
			*/
            ...
            if (PEv2_data->PEv2_AxisInternalPlanner[AxisId] != 0) {
                AxesConfig[AxisId] = Set_BitOfByte(
                    AxesConfig[AxisId], 2, true); // PK_AC_INTERNAL_PLANNER ;
            } else {
                AxesConfig[AxisId] = Set_BitOfByte(
                    AxesConfig[AxisId], 2, false); // PK_AC_INTERNAL_PLANNER ;
            }
            if (PEv2_data->PEv2_AxisPositionMode[AxisId] != 0) {
                AxesConfig[AxisId] = Set_BitOfByte(
                    AxesConfig[AxisId], 3, true); // PK_AC_POSITION_MODE ;
            } else {
                AxesConfig[AxisId] = Set_BitOfByte(
                    AxesConfig[AxisId], 3, false); // PK_AC_POSITION_MODE ;
            }
            if (PEv2_data->PEv2_AxisInvertedHome[AxisId] != 0) {
                AxesConfig[AxisId] = Set_BitOfByte(
                    AxesConfig[AxisId], 4, true); // PK_AC_INVERTED_HOME ;
            } else {
                AxesConfig[AxisId] = Set_BitOfByte(
                    AxesConfig[AxisId], 4, false); // PK_AC_INVERTED_HOME ;
            }
            if (PEv2_data->PEv2_AxisSoftLimitEnabled[AxisId] != 0) {
                AxesConfig[AxisId] = Set_BitOfByte(
                    AxesConfig[AxisId], 5, true); // PK_AC_SOFT_LIMIT_ENABLED ;
            } else {
                AxesConfig[AxisId] = Set_BitOfByte(
                    AxesConfig[AxisId], 5, false); // PK_AC_SOFT_LIMIT_ENABLED ;
            }
            if (PEv2_data->PEv2_AxisEnabledMasked[AxisId] != 0) {
                AxesConfig[AxisId] = Set_BitOfByte(
                    AxesConfig[AxisId], 7, true); // PK_AC_ENABLED_MASKED ;
            } else {
                AxesConfig[AxisId] = Set_BitOfByte(
                    AxesConfig[AxisId], 7, false); // PK_AC_ENABLED_MASKED ;
            }
            ...
            if (dev->PEv2.AxesConfig[AxisId] !=
                PEv2_data->PEv2_AxesConfig[AxisId]) {
                dev->PEv2.AxesConfig[AxisId] =
                    PEv2_data->PEv2_AxesConfig[AxisId];
                doSetup = true;
            }
			...
			*/
            AxesSwitchConfig[AxisId] =
                PEv2_data->PEv2_AxesSwitchConfig
                    [AxisId]; // initial value from ini file
            if (PEv2_data->PEv2_digin_Home_Pin[AxisId] != 0) {
                ...
                if (Home != LimM && Home != LimP) {
                    ...
                    if (IO_data->Pin[Home - 1].PinFunction !=
                        PK_PinCap_digitalInput) {
                        IO_data->Pin[Home - 1].PinFunction =
                            PK_PinCap_digitalInput;
                    }
                } else if (Home == LimP) {
                ...
                AxesSwitchConfig[AxisId] = Set_BitOfByte(
                    AxesSwitchConfig[AxisId], 2, true); // | PK_ASO_SWITCH_HOME;
            ...
            if (PEv2_data->PEv2_digin_LimitN_Enabled[AxisId] != 0) {
                AxesSwitchConfig[AxisId] =
                    Set_BitOfByte(AxesSwitchConfig[AxisId], 0,
            ...
            if (PEv2_data->PEv2_digin_LimitP_Enabled[AxisId] != 0) {
                AxesSwitchConfig[AxisId] =
                    Set_BitOfByte(AxesSwitchConfig[AxisId], 1,
            ...
            if (PEv2_data->PEv2_digin_Home_Enabled[AxisId] != 0) {
                ...
                AxesSwitchConfig[AxisId] = Set_BitOfByte(
                    AxesSwitchConfig[AxisId], 2, false); // PK_ASO_SWITCH_HOME ;
            }

            if (PEv2_data->PEv2_digin_LimitN_invert[AxisId] != 0) {
                AxesSwitchConfig[AxisId] =
                    Set_BitOfByte(AxesSwitchConfig[AxisId], 5,
            ...
            if (PEv2_data->PEv2_digin_LimitP_invert[AxisId] != 0) {
                AxesSwitchConfig[AxisId] =
                    Set_BitOfByte(AxesSwitchConfig[AxisId], 6,
            ...
            if (PEv2_data->PEv2_digin_Home_invert[AxisId] != 0) {
                AxesSwitchConfig[AxisId] =
                    Set_BitOfByte(AxesSwitchConfig[AxisId], 7,
            ...
            if (PEv2_data->PEv2_digin_Home_OnLimitN[AxisId] != 0) {
                AxesSwitchConfig[AxisId] =
                    Set_BitOfByte(AxesSwitchConfig[AxisId], 3,
            ...
            if (PEv2_data->PEv2_digin_Home_OnLimitP[AxisId] != 0) {
                AxesSwitchConfig[AxisId] =
                    Set_BitOfByte(AxesSwitchConfig[AxisId], 4,
            ...
            if (PEv2_data->PEv2_AxesSwitchConfig[AxisId] !=
                AxesSwitchConfig[AxisId]) {
                PEv2_data->PEv2_AxesSwitchConfig[AxisId] =
                    AxesSwitchConfig[AxisId];
            }

            if (dev->PEv2.AxesSwitchConfig[AxisId] !=
                PEv2_data->PEv2_AxesSwitchConfig[AxisId]) {
                dev->PEv2.AxesSwitchConfig[AxisId] =
                    PEv2_data->PEv2_AxesSwitchConfig[AxisId];
                doSetup = true;
			...
			*/
            if (dev->PEv2.PinHomeSwitch[AxisId] !=
                PEv2_data->PEv2_digin_Home_Pin[AxisId]) {
                dev->PEv2.PinHomeSwitch[AxisId] =
                    PEv2_data->PEv2_digin_Home_Pin[AxisId];
                doSetup = true;
            ...
            if (dev->PEv2.PinLimitMSwitch[AxisId] !=
                PEv2_data->PEv2_digin_LimitN_Pin[AxisId]) {
                dev->PEv2.PinLimitMSwitch[AxisId] =
                    PEv2_data->PEv2_digin_LimitN_Pin[AxisId];
                doSetup = true;
            }
            if (PEv2_data->PEv2_digin_LimitN_Pin[AxisId] !=
                0) { // check if pin is parametrized in HAL
                AxesSwitchConfig[AxisId] =
                    Set_BitOfByte(AxesSwitchConfig[AxisId], 0,
                                  true); // | PK_ASO_SWITCH_LIMIT_N;

                if (IO_data->Pin[PEv2_data->PEv2_digin_LimitN_Pin[AxisId] - 1]
                        .PinFunction != PK_PinCap_digitalInput) {
                    IO_data->Pin[PEv2_data->PEv2_digin_LimitN_Pin[AxisId] - 1]
                        .PinFunction = PK_PinCap_digitalInput;
                }
            }

            if (dev->PEv2.PinLimitPSwitch[AxisId] !=
                PEv2_data->PEv2_digin_LimitP_Pin[AxisId]) {
                dev->PEv2.PinLimitPSwitch[AxisId] =
                    PEv2_data->PEv2_digin_LimitP_Pin[AxisId];
                doSetup = true;
            }
            if (PEv2_data->PEv2_digin_LimitP_Pin[AxisId] !=
                0) { // check if pin is parametrized in HAL
                AxesSwitchConfig[AxisId] =
                    Set_BitOfByte(AxesSwitchConfig[AxisId], 1,
                                  true); // | PK_ASO_SWITCH_LIMIT_P;

                if (IO_data->Pin[PEv2_data->PEv2_digin_LimitP_Pin[AxisId] - 1]
                        .PinFunction != PK_PinCap_digitalInput) {
                    IO_data->Pin[PEv2_data->PEv2_digin_LimitP_Pin[AxisId] - 1]
                        .PinFunction = PK_PinCap_digitalInput;
                }
            }
			...
			*/
            ...
            if (PEv2_data->PEv2_stepgen_STEP_SCALE[AxisId] != 0) {
                ...
                PEv2_data->PEv2_MaxSpeed[AxisId] = abs(
                    PEv2_data->PEv2_stepgen_STEPGEN_MAXVEL[AxisId] *
                    PEv2_data->PEv2_stepgen_STEP_SCALE
                        [AxisId]); // Maximum axis speed convert (mm/s) to (pulses / s)

                PEv2_data->PEv2_MaxAcceleration[AxisId] = abs(
                    PEv2_data->PEv2_stepgen_STEPGEN_MAXACCEL[AxisId] *
                    PEv2_data->PEv2_stepgen_STEP_SCALE
                        [AxisId]); // Maximum axis deceleration convert (mm/s²) to (in pulses/s²)

                PEv2_data->PEv2_MaxDecceleration[AxisId] =
                    1.5 *
                    abs(PEv2_data->PEv2_stepgen_STEPGEN_MAXACCEL[AxisId] *
                        PEv2_data->PEv2_stepgen_STEP_SCALE
                            [AxisId]); // Maximum axis deceleration convert (mm/s²) to (in pulses/s²)

                //PEv2_data->PEv2_HomePosition[AxisId]
            }
            if (PEv2_data->PEv2_stepgen_HOME_SEARCH_VEL[AxisId] > 0 &&
                PEv2_data->PEv2_stepgen_STEPGEN_MAXVEL[AxisId] > 0 &&
                PEv2_data->PEv2_stepgen_STEPGEN_MAXVEL[AxisId] >
                    PEv2_data->PEv2_stepgen_HOME_SEARCH_VEL[AxisId]) {
                PEv2_data->PEv2_HomingSpeed[AxisId] =
                    abs(PEv2_data->PEv2_stepgen_HOME_SEARCH_VEL[AxisId] * 100 /
                        PEv2_data->PEv2_stepgen_STEPGEN_MAXVEL
                            [AxisId]); // Homing speed per axis (in %)
                PEv2_data->PEv2_HomingReturnSpeed[AxisId] = abs(
                    PEv2_data->PEv2_stepgen_HOME_LATCH_VEL[AxisId] * 100 /
                    PEv2_data->PEv2_stepgen_HOME_SEARCH_VEL
                        [AxisId]); // Homing return speed per axis (in % of the homing speed)
            } else {
                PEv2_data->PEv2_HomingSpeed[AxisId] = 30;
                PEv2_data->PEv2_HomingReturnSpeed[AxisId] = 50;
            }

            if (dev->PEv2.HomingSpeed[AxisId] !=
                PEv2_data->PEv2_HomingSpeed[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: HomingSpeed[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_HomingSpeed[AxisId]);
                dev->PEv2.HomingSpeed[AxisId] =
                    PEv2_data->PEv2_HomingSpeed[AxisId];
                doSetup = true;
            }
            if (dev->PEv2.HomingReturnSpeed[AxisId] !=
                PEv2_data->PEv2_HomingReturnSpeed[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: HomingReturnSpeed[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_HomingReturnSpeed[AxisId]);
                dev->PEv2.HomingReturnSpeed[AxisId] =
                    PEv2_data->PEv2_HomingReturnSpeed[AxisId];
            ...
            if (dev->PEv2.MaxSpeed[AxisId] !=
                    PEv2_data->PEv2_MaxSpeed[AxisId] / 1000 &&
                PEv2_data->PEv2_MaxSpeed[AxisId] > 0) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: MaxSpeed[%d] = %d\n", __FILE__,
                                __FUNCTION__, AxisId,
                                PEv2_data->PEv2_MaxSpeed[AxisId]);
                dev->PEv2.MaxSpeed[AxisId] =
                    PEv2_data->PEv2_MaxSpeed[AxisId] / 1000;
                doSetup = true;
            } else if (PEv2_data->PEv2_MaxSpeed[AxisId] == 0 &&
                       dev->PEv2.MaxSpeed[AxisId] == 0) {
            ...
            if ((int)(dev->PEv2.MaxAcceleration[AxisId] * unitconversionfactor *
                      relevantdigitsfactor) !=
                (int)(PEv2_data->PEv2_MaxAcceleration[AxisId] *
                      relevantdigitsfactor)) {
                rtapi_print_msg(
                    RTAPI_MSG_ERR,
                    ...
                    __FILE__, __FUNCTION__, AxisId,
                    (int)(PEv2_data->PEv2_MaxAcceleration[AxisId] * 1000),
                    (int)(dev->PEv2.MaxAcceleration[AxisId] * 1000000 * 1000));
                dev->PEv2.MaxAcceleration[AxisId] =
                    PEv2_data->PEv2_MaxAcceleration[AxisId] /
                    unitconversionfactor;
                doSetup = true;
            }

            if ((int)(dev->PEv2.MaxDecceleration[AxisId] *
                      unitconversionfactor * relevantdigitsfactor) !=
                (int)(PEv2_data->PEv2_MaxDecceleration[AxisId] *
                      relevantdigitsfactor)) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: MaxDecceleration[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_MaxDecceleration[AxisId]);
                dev->PEv2.MaxDecceleration[AxisId] =
                    PEv2_data->PEv2_MaxDecceleration[AxisId] /
                    unitconversionfactor;
                doSetup = true;
            }
			...
			*/
            ...
            if (PEv2_data->PEv2_stepgen_MAX_LIMIT[AxisId] >
                PEv2_data->PEv2_stepgen_MIN_LIMIT[AxisId]) {

                if (PEv2_data->PEv2_stepgen_MIN_LIMIT[AxisId] !=
                    abs(PEv2_data->PEv2_stepgen_MIN_LIMIT[AxisId])) {
                    // in pokeys only positive values are allowed - Shift reference to 0 and make sure it is positive
                    PEv2_data->PEv2_PositionOffset[AxisId] =
                        PEv2_data->PEv2_stepgen_MAX_LIMIT[AxisId] -
                        PEv2_data->PEv2_stepgen_MIN_LIMIT
                            [AxisId]; // shift reference to 0 and make sure it is positive
                } else {
                ...
                if (PEv2_data->PEv2_stepgen_STEP_SCALE[AxisId] == 0) {
                    ...
                    PEv2_data->PEv2_PositionScale[AxisId] =
                        PEv2_data->PEv2_stepgen_STEP_SCALE[AxisId];
                }

                PEv2_data->PEv2_HomePosition[AxisId] =
                    (PEv2_data->PEv2_PositionOffset[AxisId] +
                     PEv2_data->PEv2_stepgen_HOME[AxisId]) *
                    PEv2_data->PEv2_PositionScale[AxisId];
                PEv2_data->PEv2_digin_SoftLimit_PosMax[AxisId] =
                    (PEv2_data->PEv2_stepgen_MAX_LIMIT[AxisId] +
                     PEv2_data->PEv2_PositionOffset[AxisId]) *
                    PEv2_data->PEv2_PositionScale
                        [AxisId]; // Soft limit maximum position
                PEv2_data->PEv2_digin_SoftLimit_PosMin[AxisId] =
                    (PEv2_data->PEv2_stepgen_MIN_LIMIT[AxisId] +
                     PEv2_data->PEv2_PositionOffset[AxisId]) *
                    PEv2_data->PEv2_PositionScale
                        [AxisId]; // Soft limit minimum position

                PEv2_data->PEv2_ZeroPosition[AxisId] =
                    PEv2_data->PEv2_PositionOffset[AxisId] *
                    PEv2_data->PEv2_PositionScale[AxisId];
                PEv2_data->PEv2_ArmPosition[AxisId] =
                    (PEv2_data->PEv2_stepgen_MIN_LIMIT[AxisId] +
                     PEv2_data->PEv2_PositionOffset[AxisId]) *
                    PEv2_data->PEv2_PositionScale[AxisId];
                ...
                rtapi_print_msg(
                    RTAPI_MSG_ERR,
                    "PoKeys: %s:%s: MaxLimit[%d] = %d ; MinLimit[%d] = %d\n",
                    __FILE__, __FUNCTION__, AxisId,
                    PEv2_data->PEv2_stepgen_MAX_LIMIT[AxisId], AxisId,
                    PEv2_data->PEv2_stepgen_MIN_LIMIT[AxisId]);

                if (PEv2_data->PEv2_stepgen_MAX_LIMIT[AxisId] !=
                    abs(PEv2_data->PEv2_stepgen_MAX_LIMIT[AxisId])) {
                    // in pokeys only positive values are allowed - Shift reference to 0 and make sure it is positive
                    PEv2_data->PEv2_PositionOffset[AxisId] =
                        PEv2_data->PEv2_stepgen_MIN_LIMIT[AxisId] -
                        PEv2_data->PEv2_stepgen_MAX_LIMIT
                            [AxisId]; // shift reference to 0 and make sure it is positive
                } else {
                    // PEv2_stepgen_HOME[AxisId]
                    PEv2_data->PEv2_PositionOffset[AxisId] = 0;
                ...
                if (PEv2_data->PEv2_stepgen_STEP_SCALE[AxisId] == 0) {
                    ...
                    PEv2_data->PEv2_PositionScale[AxisId] =
                        PEv2_data->PEv2_stepgen_STEP_SCALE[AxisId] * (0 - 1);
                }
            ...
            if (dev->PEv2.SoftLimitMinimum[AxisId] !=
                PEv2_data->PEv2_SoftLimitMinimum[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: SoftLimitMinimum[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_SoftLimitMinimum[AxisId]);
                dev->PEv2.SoftLimitMinimum[AxisId] =
                    PEv2_data->PEv2_SoftLimitMinimum[AxisId];
            ...
            if (dev->PEv2.SoftLimitMaximum[AxisId] !=
                PEv2_data->PEv2_SoftLimitMaximum[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: SoftLimitMaximum[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_SoftLimitMaximum[AxisId]);
                dev->PEv2.SoftLimitMaximum[AxisId] =
                    PEv2_data->PEv2_SoftLimitMaximum[AxisId];
            ...
            if (dev->PEv2.AxisEnableOutputPins[AxisId] !=
                PEv2_data->PEv2_digout_AxisEnable_Pin[AxisId]) {
                rtapi_print_msg(
                    RTAPI_MSG_ERR,
                    "PoKeys: %s:%s: AxisEnableOutputPins[%d] = %d\n", __FILE__,
                    __FUNCTION__, AxisId,
                    PEv2_data->PEv2_digout_AxisEnable_Pin[AxisId]);
                dev->PEv2.AxisEnableOutputPins[AxisId] =
                    PEv2_data->PEv2_digout_AxisEnable_Pin[AxisId];
            ...
            if (PEv2_data->PEv2_digout_AxisEnable_Pin[AxisId] !=
                0) { // check if pin is parametrized in HAL
                if (IO_data
                        ->Pin[PEv2_data->PEv2_digout_AxisEnable_Pin[AxisId] - 1]
                ...
                Pins_DigitalValueSet_ignore
                    [PEv2_data->PEv2_digout_AxisEnable_Pin[AxisId] - 1] = true;
            }
            if (dev->PEv2.InvertAxisEnable[AxisId] !=
                PEv2_data->PEv2_digout_AxisEnable_invert[AxisId]) {
                rtapi_print_msg(
                    RTAPI_MSG_ERR, "PoKeys: %s:%s: InvertAxisEnable[%d] = %d\n",
                    __FILE__, __FUNCTION__, AxisId,
                    PEv2_data->PEv2_digout_AxisEnable_invert[AxisId]);
                dev->PEv2.InvertAxisEnable[AxisId] =
                    PEv2_data->PEv2_digout_AxisEnable_invert[AxisId];
            ...
            if (dev->PEv2.FilterLimitMSwitch[AxisId] !=
                PEv2_data->PEv2_digin_LimitN_Filter[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: FilterLimitMSwitch[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_digin_LimitN_Filter[AxisId]);
                dev->PEv2.FilterLimitMSwitch[AxisId] =
                    PEv2_data->PEv2_digin_LimitN_Filter[AxisId];
            ...
            if (dev->PEv2.FilterLimitPSwitch[AxisId] !=
                PEv2_data->PEv2_digin_LimitP_Filter[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: FilterLimitPSwitch[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_digin_LimitP_Filter[AxisId]);
                dev->PEv2.FilterLimitPSwitch[AxisId] =
                    PEv2_data->PEv2_digin_LimitP_Filter[AxisId];
            ...
            if (dev->PEv2.FilterHomeSwitch[AxisId] !=
                PEv2_data->PEv2_digin_Home_Filter[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: FilterHomeSwitch[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_digin_Home_Filter[AxisId]);
                dev->PEv2.FilterHomeSwitch[AxisId] =
                    PEv2_data->PEv2_digin_Home_Filter[AxisId];
			...
			*/
            ...
            if (dev->PEv2.HomingAlgorithm[AxisId] !=
                PEv2_data->PEv2_HomingAlgorithm[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: HomingAlgorithm[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_HomingAlgorithm[AxisId]);
                dev->PEv2.HomingAlgorithm[AxisId] =
                    PEv2_data->PEv2_HomingAlgorithm[AxisId];
            ...
            if (PEv2_data->PEv2_stepgen_STEP_SCALE[AxisId] != 0) {
                PEv2_data->PEv2_HomeBackOffDistance[AxisId] =
                    PEv2_data->PEv2_stepgen_HOME_OFFSET[AxisId] *
                    PEv2_data->PEv2_stepgen_STEP_SCALE
                        [AxisId]; // Home position offset
            }
            if (dev->PEv2.HomeBackOffDistance[AxisId] !=
                PEv2_data->PEv2_HomeBackOffDistance[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: HomeBackOffDistance[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_HomeBackOffDistance[AxisId]);
                dev->PEv2.HomeBackOffDistance[AxisId] =
                    PEv2_data->PEv2_HomeBackOffDistance[AxisId];
			...
			*/
            if (dev->PEv2.MPGjogEncoder[AxisId] !=
                PEv2_data->PEv2_MPGjogEncoder[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: MPGjogEncoder[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_MPGjogEncoder[AxisId]);
                dev->PEv2.MPGjogEncoder[AxisId] =
                    PEv2_data->PEv2_MPGjogEncoder[AxisId];
            ...
            if (dev->PEv2.MPGjogDivider[AxisId] !=
                PEv2_data->PEv2_MPGjogDivider[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: MPGjogDivider[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_MPGjogDivider[AxisId]);
                dev->PEv2.MPGjogDivider[AxisId] =
                    PEv2_data->PEv2_MPGjogDivider[AxisId];
            ...
            if (dev->PEv2.MPGjogMultiplier[AxisId] !=
                PEv2_data->PEv2_MPGjogMultiplier[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: MPGjogMultiplier[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_MPGjogMultiplier[AxisId]);
                dev->PEv2.MPGjogMultiplier[AxisId] =
                    PEv2_data->PEv2_MPGjogMultiplier[AxisId];
            ...
            if (dev->PEv2.FilterProbeInput !=
                PEv2_data->PEv2_digin_Probe_Filter[AxisId]) {
                rtapi_print_msg(RTAPI_MSG_ERR,
                                "PoKeys: %s:%s: FilterProbeInput[%d] = %d\n",
                                __FILE__, __FUNCTION__, AxisId,
                                PEv2_data->PEv2_digin_Probe_Filter[AxisId]);
                dev->PEv2.FilterProbeInput =
                    PEv2_data->PEv2_digin_Probe_Filter[AxisId];
...
MODULE_INFO(linuxcnc,
            "param:PEv2.#.home_sequence:s32:8:rw:home_sequence:None:None");
MODULE_INFO(linuxcnc, "pin:PEv2.#.AxesConfig:u32:8:out::None:None");
MODULE_INFO(linuxcnc,
            "param:PEv2.#.AxisEnabled:s32:8:rw:Axis enabled:None:None");
MODULE_INFO(linuxcnc,
            "param:PEv2.#.AxisInverted:s32:8:rw:Axis inverted:None:None");
...
MODULE_INFO(linuxcnc,
            "param:PEv2.#.digin.SoftLimit.PosMin:u32:8:rw::None:None");
MODULE_INFO(linuxcnc,
            "param:PEv2.#.digin.SoftLimit.PosMax:u32:8:rw::None:None");
...
MODULE_INFO(linuxcnc,
            "param:PEv2.#.HomeAlg.OnHome.ArmEncoder:bit:8:rw::None:None");
MODULE_INFO(linuxcnc,
            "param:PEv2.#.HomeAlg.OnHome.RevDirection:bit:8:rw::None:None");
MODULE_INFO(linuxcnc,
            "param:PEv2.#.HomeAlg.OnHome.ReducedSpeed:bit:8:rw::None:None");
MODULE_INFO(linuxcnc, "param:PEv2.#.HomeAlg.OutHome.Stop:bit:8:rw::None:None");
MODULE_INFO(linuxcnc,
            "param:PEv2.#.HomeAlg.OutHome.ArmEncoder:bit:8:rw::None:None");
MODULE_INFO(linuxcnc,
            "param:PEv2.#.HomeAlg.OutHome.RevDirection:bit:8:rw::None:None");
MODULE_INFO(linuxcnc,
            "param:PEv2.#.HomeAlg.OutHome.ReducedSpeed:bit:8:rw::None:None");
...
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.stepgen.STEPGEN_MAXVEL:float:8:in::None:None");
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.stepgen.STEPGEN_MAXACCEL:float:8:in::None:None");
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.params.Feedback_Encoder_Id:float:8:in::None:None");
...
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.stepgen.HOME-SEARCH_VEL:float:8:in::None:None");
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.stepgen.HOME-LATCH-VEL:float:8:in::None:None");
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.stepgen.HOME-FINAL-VEL:float:8:in::None:None");
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.stepgen.HOME-IGNORE-LIMITS:s32:8:in::None:None");
...
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.digin.LimitN.DedicatedInput:bit:8:out::None:None");
...
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.digin.LimitP.DedicatedInput:bit:8:out::None:None");
...
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.digin.Home.DedicatedInput:bit:8:out::None:None");
...
MODULE_INFO(linuxcnc,
            "param:PEv2.#.digout.AxisEnable.Pin:u32:8:rw:Axis enabled output "
...
MODULE_INFO(
    linuxcnc,
    "param:PEv2.digout.Emergency.Pin:u32:0:rw:added in component only for "
...
MODULE_INFO(linuxcnc,
            "pin:PEv2.#.digout.LimitOverride.out:bit:8:out::None:None");
...
MODULE_INFO(linuxcnc,
            "pin:PEv2.digout.ExternalRelay-#.out:bit:4:in::None:None");
...
MODULE_INFO(linuxcnc,
            "param:PEv2.digin.Probe.Pin:u32:0:rw:Probe input (0:disabled, "
            "1-8:external inputs, 9+ Pin ID-9):None:None");
MODULE_INFO(
    linuxcnc,
    "param:PEv2.digin.Probe.invert:u32:0:rw:Probe input polarity:None:None");
...
MODULE_INFO(linuxcnc,
            "pin:PEv2.BacklashCompensationEnabled:u32:0:io::None:None");
#endif // MODULE_INFO