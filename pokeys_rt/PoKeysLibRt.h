...
EXPORT_SYMBOL(PK_ConnectToNetworkDevice);
EXPORT_SYMBOL(PK_DisconnectDevice);
EXPORT_SYMBOL(PK_GetCurrentDeviceConnectionType);
EXPORT_SYMBOL(PK_SaveConfiguration);
EXPORT_SYMBOL(PK_ClearConfiguration);
EXPORT_SYMBOL(PK_CustomRequest);
EXPORT_SYMBOL(PK_DeviceNameSet);
EXPORT_SYMBOL(PK_CheckPinCapabilityByDevice);
EXPORT_SYMBOL(PK_CheckPinCapabilityByTypeID);
EXPORT_SYMBOL(PK_CloneDeviceStructure);
EXPORT_SYMBOL(PK_ReleaseDeviceStructure);

EXPORT_SYMBOL(PK_DeviceDataGet);
EXPORT_SYMBOL(PK_DeviceActivation);
EXPORT_SYMBOL(PK_DeviceActivationClear);

EXPORT_SYMBOL(PK_ReadDeviceLog);
EXPORT_SYMBOL(PK_NetworkConfigurationSet);
EXPORT_SYMBOL(PK_PinConfigurationGet);
EXPORT_SYMBOL(PK_PinConfigurationSet);
EXPORT_SYMBOL(PK_EncoderConfigurationGet);
EXPORT_SYMBOL(PK_EncoderConfigurationSet);
EXPORT_SYMBOL(PK_EncoderValuesGet);
EXPORT_SYMBOL(PK_EncoderValuesSet);

EXPORT_SYMBOL(PK_DigitalIOSet);
EXPORT_SYMBOL(PK_DigitalIOGet);
EXPORT_SYMBOL(PK_DigitalIOSetSingle);
EXPORT_SYMBOL(PK_DigitalIOGetSingle);

EXPORT_SYMBOL(PK_DigitalCounterGet);
EXPORT_SYMBOL(PK_DigitalCounterClear);
EXPORT_SYMBOL(PK_IsCounterAvailable);
EXPORT_SYMBOL(PK_IsCounterAvailableByDevice);
EXPORT_SYMBOL(PK_IsCounterAvailableByTypeID);
EXPORT_SYMBOL(PK_AnalogIOGet);
EXPORT_SYMBOL(PK_AnalogIOGetAsArray);
EXPORT_SYMBOL(PK_AnalogRCFilterGet);
EXPORT_SYMBOL(PK_MatrixKBConfigurationGet);
EXPORT_SYMBOL(PK_MatrixKBConfigurationSet);
EXPORT_SYMBOL(PK_MatrixKBStatusGet);
EXPORT_SYMBOL(PK_PWMConfigurationSet);
EXPORT_SYMBOL(PK_PWMUpdate);
EXPORT_SYMBOL(PK_PWMConfigurationGet);
EXPORT_SYMBOL(PK_PWMConfigurationSetDirectly);
EXPORT_SYMBOL(PK_PWMUpdateDirectly);
EXPORT_SYMBOL(PK_LCDConfigurationGet);
EXPORT_SYMBOL(PK_LCDConfigurationSet);
EXPORT_SYMBOL(PK_LCDUpdate);
EXPORT_SYMBOL(PK_LCDSetCustomCharacters);
EXPORT_SYMBOL(PK_LCDChangeMode);
EXPORT_SYMBOL(PK_LCDInit);
EXPORT_SYMBOL(PK_LCDClear);
EXPORT_SYMBOL(PK_LCDMoveCursor);
EXPORT_SYMBOL(PK_LCDPrint);
EXPORT_SYMBOL(PK_LCDPutChar);
EXPORT_SYMBOL(PK_LCDEntryModeSet);
EXPORT_SYMBOL(PK_LCDDisplayOnOffControl);
EXPORT_SYMBOL(PK_MatrixLEDConfigurationSet);
EXPORT_SYMBOL(PK_MatrixLEDConfigurationGet);
EXPORT_SYMBOL(PK_MatrixLEDUpdate);
EXPORT_SYMBOL(PK_PEv2_StatusGet);
EXPORT_SYMBOL(PK_PEv2_Status2Get);
EXPORT_SYMBOL(PK_PEv2_PulseEngineSetup);
EXPORT_SYMBOL(PK_PEv2_AdditionalParametersGet);
EXPORT_SYMBOL(PK_PEv2_AdditionalParametersSet);
EXPORT_SYMBOL(PK_PEv2_AxisConfigurationGet);
EXPORT_SYMBOL(PK_PEv2_AxisConfigurationSet);
EXPORT_SYMBOL(PK_PEv2_PositionSet);
EXPORT_SYMBOL(PK_PEv2_PulseEngineStateSet);
EXPORT_SYMBOL(PK_PEv2_PulseEngineMove);
EXPORT_SYMBOL(PK_PEv2_PulseEngineMovePV);
EXPORT_SYMBOL(PK_PEv2_ExternalOutputsGet);
EXPORT_SYMBOL(PK_PEv2_ExternalOutputsSet);
EXPORT_SYMBOL(PK_PEv2_BufferFill);
EXPORT_SYMBOL(PK_PEv2_BufferFill_16);
EXPORT_SYMBOL(PK_PEv2_BufferFillLarge);
EXPORT_SYMBOL(PK_PEv2_BufferFillLarge_16);
EXPORT_SYMBOL(PK_PEv2_BufferClear);
EXPORT_SYMBOL(PK_PEv2_PulseEngineReboot);
EXPORT_SYMBOL(PK_PEv2_HomingStart);
EXPORT_SYMBOL(PK_PEv2_HomingFinish);
EXPORT_SYMBOL(PK_PEv2_ProbingStart);
EXPORT_SYMBOL(PK_PEv2_ProbingHybridStart);
EXPORT_SYMBOL(PK_PEv2_ProbingFinish);
EXPORT_SYMBOL(PK_PEv2_ProbingFinishSimple);
...
EXPORT_SYMBOL(PK_PEv2_ThreadingForceTriggerReady);
EXPORT_SYMBOL(PK_PEv2_ThreadingTrigger);
EXPORT_SYMBOL(PK_PEv2_ThreadingRelease);
EXPORT_SYMBOL(PK_PEv2_ThreadingStatusGet);
EXPORT_SYMBOL(PK_PEv2_ThreadingCancel);
EXPORT_SYMBOL(PK_PEv2_ThreadingSetup);
EXPORT_SYMBOL(PK_PEv2_BacklashCompensationSettings_Get);
EXPORT_SYMBOL(PK_PEv2_BacklashCompensationSettings_Set);
EXPORT_SYMBOL(PK_PoStep_ConfigurationGet);
EXPORT_SYMBOL(PK_PoStep_ConfigurationSet);
...
EXPORT_SYMBOL(PK_I2CWriteAndReadStart);
EXPORT_SYMBOL(PK_I2CWriteStatusGet);
EXPORT_SYMBOL(PK_I2CReadStart);
EXPORT_SYMBOL(PK_I2CReadStatusGet);
EXPORT_SYMBOL(PK_I2CBusScanStart);
EXPORT_SYMBOL(PK_I2CBusScanGetResults);
EXPORT_SYMBOL(PK_PoNETGetPoNETStatus);
EXPORT_SYMBOL(PK_PoNETGetModuleSettings);
EXPORT_SYMBOL(PK_PoNETGetModuleStatusRequest);
EXPORT_SYMBOL(PK_PoNETGetModuleStatus);
EXPORT_SYMBOL(PK_PoNETSetModuleStatus);
...
EXPORT_SYMBOL(PK_1WireWriteReadStartEx);
EXPORT_SYMBOL(PK_1WireReadStatusGet);
EXPORT_SYMBOL(PK_1WireBusScanStart);
EXPORT_SYMBOL(PK_1WireBusScanGetResults);
EXPORT_SYMBOL(PK_1WireBusScanContinue);
EXPORT_SYMBOL(PK_1WireBusScanStop);
...
EXPORT_SYMBOL(PK_PoILGetState);
EXPORT_SYMBOL(PK_PoILSetCoreState);
EXPORT_SYMBOL(PK_PoILSetMasterEnable);
EXPORT_SYMBOL(PK_PoILResetCore);
EXPORT_SYMBOL(PK_PoILSetDebugMode);
EXPORT_SYMBOL(PK_PoILReadMemory);
EXPORT_SYMBOL(PK_PoILWriteMemory);
EXPORT_SYMBOL(PK_PoILEraseMemory);
EXPORT_SYMBOL(PK_PoILChunkReadMemory);
EXPORT_SYMBOL(PK_PoILChunkReadMemoryInternalAddress);
...
EXPORT_SYMBOL(PK_CANConfigure);
EXPORT_SYMBOL(PK_CANRegisterFilter);
EXPORT_SYMBOL(PK_CANWrite);
EXPORT_SYMBOL(PK_CANRead);
EXPORT_SYMBOL(PK_CANFlush);
EXPORT_SYMBOL(PK_WS2812_Update);
EXPORT_SYMBOL(PK_WS2812_SendLEDdata);
EXPORT_SYMBOL(PK_SL_SetPinFunction);
EXPORT_SYMBOL(PK_SL_GetPinFunction);
EXPORT_SYMBOL(PK_SL_DigitalOutputSet);
EXPORT_SYMBOL(PK_SL_DigitalInputGet);
EXPORT_SYMBOL(PK_SL_AnalogInputGet);
EXPORT_SYMBOL(PK_SL_EncoderValueGet);
